...
{
    public class AbhiBusAPILayer : IAbhiBusAPILayer
    {
        public DataTable GetSources()
        {
            try
            {
                ...
                IAbhiBusGetSources gs = XmlRpcProxyGen.Create<IAbhiBusGetSources>();
        ...
        public DataTable GetDestinations(string sourceId)
        {
            try
            {
                ...
                IAbhiBusGetDestinations gd = XmlRpcProxyGen.Create<IAbhiBusGetDestinations>();
        ...
        public DataTable GetServices(string journeyDate, string sourceId, string destinationId)
        {
            try
            {
                ...
                IAbhiBusGetServices gs = XmlRpcProxyGen.Create<IAbhiBusGetServices>();
                ...
                foreach (XmlRpcStruct item in response)
                {
                    ...
                    foreach (var item1 in item.Keys)
                    {
                        ...
                        else if (item1.ToString() == "TotalAvailableSeats")
                        {
                            ...
                            foreach (string str in boardingPoints)
                            {
                                if (str != "")
                                {
                                    ...
                                    if (sss == "")
                                    {
                                        ...
                                        sssWithIds = " " + s[0].ToString() + " - " + ss[2].ToString() + " " + " - " + ss[0].ToString() + " %&&% " + s[1].ToString();
                                        sssWithIdsAndAddress = " " + s[0].ToString() + " - " + ss[2].ToString() + " " + " - " + ss[0].ToString() + " %&&% " + s[1].ToString();
                                    }
                                    else
                                    {
                                        sss = sss + " %&% " + s[0].ToString() + " - " + ss[2].ToString();
                                        sssWithIds = sssWithIds + " %&% " + s[0].ToString() + " - " + ss[2].ToString() + " - " + ss[0].ToString() + " %&&% " + s[1].ToString();
                                        sssWithIdsAndAddress = sssWithIdsAndAddress + " %&% " + s[0].ToString() + " - " + ss[2].ToString() + " - " + ss[0].ToString() + " %&&% " + s[1].ToString();
                                    }
                                }
                            }
        ...
        public DataTable GetSeatLayout(string journeyDate, string sourceId, string destinationId, string serviceId, string seatSleeper)
        {
            try
            {
                ...
                IAbhiBusGetSeatLayout gs1 = XmlRpcProxyGen.Create<IAbhiBusGetSeatLayout>();
                ...
                foreach (XmlRpcStruct item in response1)
                {
                    ...
                    foreach (var item1 in item.Keys)
                    {
                        ...
                        else if (item1.ToString() == "seat_fare")//(item1.ToString() == "seat_fare_with_taxes")
                        {
                            dr["seat_fare_with_taxes"] = item[item1].ToString();
                        }
                        else if (item1.ToString() == "boardingpoints")
                ...
                //    string seatLayoutString = dt.Rows[0]["tot_availableseat_num"].ToString();
                ...
                //    string seatLayoutString1 = dt.Rows[0]["bookedseats"].ToString();
        ...
        public DataTable SeatBlocking(string journeyDate, string sourceId, string destinationId, string serviceId, string selectedSeats)
        {
            try
            {
                ...
                IAbhiBusSeatBlocking gs = XmlRpcProxyGen.Create<IAbhiBusSeatBlocking>();
           ...
           , string passengerName, string boardingPointId, string custAddress, string custName, string custPhoneNo, string custEmailId, string referenceNo)
        {
            ...
            try
            {
                ...
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(AbhiBusConstants.URL);
                request.Method = "POST";
        ...
        public DataTable GetTicketInfo(string bookingReferenceNumber)
        {
            try
            {
                ...
                IAbhiBusGetTicketInfo gd = XmlRpcProxyGen.Create<IAbhiBusGetTicketInfo>();
        ...
        public DataTable TicketCancellation(string ticketNo)
        {
            try
            {
                ...
                XmlRpcStruct data = new XmlRpcStruct();
                data.Add("ticketno", ticketNo);
                IAbhiBusTicketCancellation gd = XmlRpcProxyGen.Create<IAbhiBusTicketCancellation>();
