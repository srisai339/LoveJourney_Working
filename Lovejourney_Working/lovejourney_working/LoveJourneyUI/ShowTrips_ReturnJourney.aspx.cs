...
public partial class ShowTrips_ReturnJourney : System.Web.UI.Page
{
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    ////            //ddlDestinations.DataSource = (DataTable)Session["sesDTDestinations"];//ObjDataset.Tables[0];
                    ////            //ddlDestinations.DataTextField = "DestinationName";//"SourceName";
                    ...
                    //ListItem lt = ddlSources.Items.FindByText(baseCls.preLoadParams[5].ToString());
