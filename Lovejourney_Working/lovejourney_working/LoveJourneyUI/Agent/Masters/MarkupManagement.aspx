<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="MarkupManagement.aspx.cs" Inherits="Agent_Masters_MarkupManagement" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
     <td align="center" width="990">
        ...
        <tr>
        <td align="right" >
          <asp:LinkButton ID="btnMarkupback" Text="Back" runat="server"  ForeColor="#006699"
                        ...
                        <td align="center">
                            ...
                            <tr><asp:Label ID="lblType1" runat="server" ></asp:Label></tr>
                                ...
                                <tr id="flights" runat="server" visible="false" >
                                    ...
                                    <td align="left">
                                        <asp:DropDownList Id="ddlFlightType" runat="server" width="130" AutoPostBack="True"  >
                                        <asp:ListItem>--Select---</asp:ListItem>
