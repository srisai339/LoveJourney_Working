<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="ConsolidatedFrmBookingStatus.aspx.cs" Inherits="Agent_Masters_ConsolidatedFrmBookingStatus" %>
...
<table width="100%">
        <tr>
  <td align="right">
                                    <asp:LinkButton ID="lbtnCancelstatus" runat="server" Text="Back"  ForeColor="#006699"
