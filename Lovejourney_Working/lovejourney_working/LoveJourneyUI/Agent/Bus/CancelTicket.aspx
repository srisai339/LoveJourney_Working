<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true"
    CodeFile="CancelTicket.aspx.cs" Inherits="Agent_CancelTicket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="900" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="100%" height="30px" valign="middle"  class="tr" id="tdmsg"
                runat="server" visible="false" colspan="2"  align="center">
