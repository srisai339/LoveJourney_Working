<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bookings.aspx.cs" Inherits="Agent_Bookings" EnableEventValidation="false" %>
        ...
        <tr>
            <td width="100%" align="center" bgcolor="#ffffff">
                <div id="divBookedReport" runat="server" visible="true">
                    <fieldset>
                        <legend runat="server" id="legendBookedReport">&nbsp;&nbsp;Tickets&nbsp;&nbsp;</legend>
                        <br />
                        <table width="80%">
                                ...
                                <td width="32%" align="left">
                                    <span id="mainDiv" style="display: none" class="loadingBackground"></span><span id="contentDiv"
                                        ...
                                        <div class="registerhead">
                                            <img src="../../images/loading.gif" alt="http://www.lovejourney.in Bus Car Flight Pan Card"
                                                width="150" height="150" alt="Loading" />
                                        </div>
                                    </span>
                            ...
                            <tr>
                                ...
                                <td width="35%" align="left">
                                    <asp:TextBox ID="txtusername" runat="server" CssClass="Textbox" Visible="false" />
                                </td>
                                <td width="18%" align="left">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="32%" align="right">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnExport" runat="server" OnClick="btnExport_Click"
                                        Text="Export To Excel" CssClass="buttonBook" Style="cursor: pointer;" />
                                </td>
                            </tr>
                        </table>
                        <br />
                        <asp:GridView ID="gvBookings" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="LJ Fare" SortExpression="MBFare" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblMBFare" Text='<%# Eval("AmountPayable") %>' runat="server" />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="MarkUp" SortExpression="Comment" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblMarkUp" Text='<%# Eval("Markup") %>' runat="server" />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:Label ID="lblMarkUpTotal" ForeColor="Red" runat="server" Visible="false" />
                                    </FooterTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Total Fare" SortExpression="ActualFare">
                                    <ItemTemplate>
                                        <asp:Label ID="lblActualFare" Text='<%# Eval("TotalFare") %>' runat="server" />
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:TemplateField HeaderText="User Name" SortExpression="UserNames" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUserNames" Text='<%# Eval("UserNames") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Booking Date & Time" SortExpression="CreatedDate">
                                    <ItemTemplate>
                                            ...
                                            <table width="900" align="center">
                                                <tr>
                                                    ...
                                                    <td width="135" align="right">
                                                        <span class="actions">
                                                            <%--<asp:RadioButton ID="radioButtonCancel" runat="server" AutoPostBack="true" Visible="false" Text="Cancel"
                                                                ...
                                                                <table width="900" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td align="left" width="300" height="96" valign="top">
                                                                            <img src="../../Newimages/New_Logo.png" width="143" height="88" border="0" title="Love Journey" />&nbsp;&nbsp;
                                                                        </td>
                                                                        <td align="right">
                                                                                                                ...
                                                                                                                <td align="center">
                                                                                                                    <table width="580" border="0" cellspacing="0" cellpadding="0">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td align="left">
                                                                                                                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("Markup") %>' />
                                                                                                                            </td>
                                                                                                                            <td align="left">
                                                                                                                                <b><u>Total</u></b>
                                                                                                                            </td>
