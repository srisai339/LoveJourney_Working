<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="Markup.aspx.cs" Inherits="Agent_Bus_Markup" %>
  ...
  <tr>
     <td align="center" width="990">
       ...
       <tr>
                        <td align="center">
                            ...
                            <tr><asp:Label ID="lblType1" runat="server" ></asp:Label></tr>
                                <tr id="typed" runat="server">
                                    ...
                                    <td align="left">
                                       ...
                                       <asp:ListItem>Hotels</asp:ListItem>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvddltype" runat="server" ControlToValidate="ddltype" ErrorMessage="Please Select"  ValidationGroup="submit1" Display="None" InitialValue="--Select--"></asp:RequiredFieldValidator>
                                    <asp:ValidatorCalloutExtender ID="vcerfvddltype" runat="server" TargetControlID="rfvddltype"></asp:ValidatorCalloutExtender>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtAmount" runat="server" maxlength="4" 
                                           ></asp:TextBox>
                                      ...
                                      <asp:FilteredTextBoxExtender ID="ftb1" runat="server"
               ...
               <asp:Button ID="btnAd" runat="server" Text="Add"     ValidationGroup="submit1" CssClass="buttonBook"
                                            onclick="btnAd_Click"/>
                                           
                                        <asp:Label ID="lblid" runat="server" Visible="false"></asp:Label>
       <asp:Button ID="btnUpdate" runat="server" Text="Update" Visible="false" onclick="btnUpdate_Click" class="buttonBook"
                                             />
       <asp:Button ID="btnCancel" runat="server" Text="Cancel" Visible="false" onclick="btnCancel_Click"  class="buttonBook"
                                             />
                                    </td>
                                </tr>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action"  Visible="true" >
                           <ItemTemplate>
                                ...
                                <asp:Button ID="btnEdit" runat="server" Text="Edit"  CommandName="Edit" CommandArgument='<%#Eval("Id") %>' class="buttonBook"/>
