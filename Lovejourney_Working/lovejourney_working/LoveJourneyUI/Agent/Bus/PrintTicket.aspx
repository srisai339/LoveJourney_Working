<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Bus/MasterPage.master" AutoEventWireup="true"
    CodeFile="PrintTicket.aspx.cs" Inherits="Agent_PrintTicket" %>
                                ...
                                <table width="400" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="50%" align="right" >
                                            Enter Ref No&nbsp;:&nbsp;  <strong style="color: Red">*</strong>
                                        </td>
                                      
                                        <td align="left" height="34" width="60%">
                                            <asp:TextBox ID="txtMBRefNo" MaxLength="50" runat="server" CssClass="textfield_sleep" />
                                             <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="txtMBRefNo" Display="None" ErrorMessage="Please Enter Ref No." ValidationGroup="signin" />
                                    ...
                                    <tr>
                                        <td valign="top" height="20" align="left">
                                            <table width="347" height="45" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="50">
                                                        <img src="../../images/print_t.png" width="37" height="37" />
                                                    </td>
                                            ...
                                            <table width="300" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td height="28" align="left">
                                                        ...
                                                        <ajax:ValidatorCalloutExtender ID="vceLuserName" runat="server" TargetControlID="rfvUsername">
