<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Flight/MasterPage.master"
    AutoEventWireup="true" CodeFile="frmInternationalAvailablity.aspx.cs" Inherits="Agent_Flight_frmInternationalAvailablity" %>
  ...
  <script language ="javascript" type="text/javascript">
      ...
      function showSNFoneway() {
          ...
          if (document.getElementById("<%=lnkSNFshow.ClientID %>").text == "SNF") {
              ...
              document.getElementById('<%=lnkSNFshow.ClientID %>').show();
              return false;
          }
      }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <table width="980">
                                            ...
                                            <tr>
                                                <td width="100%" align="center">
                                                    <table align="center" id="tblSearch" runat="server" valign="top" width="100%" border="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left" width="100%">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td valign="top" align="left">
                                                                                                                                <asp:TextBox ID="txtIntDeptDate" ValidationGroup="Search" runat="server" onkeyup="return tabE(this,event)"
                                                                                                                                                            ...
                                                                                                                                                            TabIndex="4"  OnTextChanged="txtIntDeptDate_TextChanged" />
                                                                                                                                        ...
                                                                                                                                        <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" height="20">
                                                                                                                                                    ...
                                                                                                                                                    &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                                    <input id="Text5" type="text" style="border: 0px; text-align:left;background-color:White;" disabled="disabled" class="progress" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" height="20">
                                                                                                                                            ...
                                                                                                                                            <tr>
                                                                                                                                                <td align="center" height="20">
                                                                                                                                                    <input id="Text6" type="text" style="border: 0; text-align: center; background-color:White" class="progress" />
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                        </table>
                                                                                                                                    </td>
                                                                    ...
                                                                    <table align="left" id="Table1" runat="server" valign="top" width="400" border="0"
                                                                    cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                                                                            ...
                                                                                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                                                <tr>
                                                                                                                                                  <td width="150" valign="top" align="left" class="lj_hd">
                                                                                                                                                    ...
                                                                                                                                                    <td   align="left" style="font-weight:bold;color:Black;" width="25">:</td>
                                                                                                                                                    <td valign="top" align="left">
                                                                                                                                                        <asp:DropDownList ID="ddlIntCabinType" CssClass="lj_inp" runat="server" TabIndex="9" >
                                                                                                                                                <asp:ListItem Selected="True" Value="E">Economy Lowest Fare</asp:ListItem>
                                                                                                                                                <asp:ListItem Value="ER">Economy Refundable Fare</asp:ListItem>
                                                                                                                                                <asp:ListItem Value="B">Business / First Class</asp:ListItem>
                                                                                                                                            </asp:DropDownList>
                                                                ...
                                                                <td class="link_rt" valign="top" align="right" width="340" height="310" >
                                                                    <%--  <asp:Image ID="imgFlight" Width="564" Height="310" ImageUrl="~/images/flight.jpg"
                                                                    runat="server" />--%>
                                                                    <%-- <img src="../../images/flight.jpg" />--%>
                                                                   <%-- <asp:Image ID="imgFlight" Width="367" Height="336" ImageUrl="~/images/flight.jpg"
                                                                        runat="server" />--%>
                                                                    
    
    
    <table width="320" border="0" cellspacing="0" cellpadding="0" height="310">
  ...
  <tr>
    <td align="center"><a href="frmDomesticAvailability.aspx" target="_blank"><img src="../../img/flight.png" width="86" height="76"  /></a></td>
  ...
  <tr>
    <td align="center" class="flights"><a href="frmDomesticAvailability.aspx" target="_blank">Flights</a></td>
  ...
  <tr>
    ...
    <td align="center"><a href="../Recharge/Recharge.aspx"><img src="../../img/RECHARGE.png" width="86" height="76"  /></a></td>
    <td align="center"><img src="../../img/TICKET.png" width="86" height="76"  /></td>
  </tr>
  <tr>
    <td align="center" class="flights">Train</td>
    <td align="center" class="flights"><a href="../Recharge/Recharge.aspx">Recharge</a></td>
  ...
  <tr>
    ...
    <td align="center" class="flights">Dmr</td>
                    ...
                    <asp:Panel ID="InternationalFlightsPanel" runat="server" Width="900px">
                        <table width="90%">
                            <tr>
                              ...
                              <tr>
                                        ...
                                        <tr id="ModifySearch"  runat="server" visible="false">
                                            <td align="center" width="800" style="padding-right:20px"; >
                                                <div id="dvModifySearch" visible="false" runat="server" style="margin-left:15px;width:800;">
                                                    <h3>
                                                        Modify Search</h3>
  ...
  <tr>
    ...
    <td align="center" colspan="2">
       ...
       <asp:ImageButton ID="imgsearch" runat="server" ImageUrl="~/images/check-availability-btn.jpg" Width="159"
                                                                        OnClick="imgsearch_Click"  OnClientClick="return startsearch1();"  ValidationGroup="SearchInt1" />
    </td>
  </tr>
  <tr>
   ...
   <tr>
    ...
    <td width="3"><img src="../../images/lb2.png" width="3" height="29"  /></td>
                                           ...
                                           <tr>
                                                                <td>
                                                                  <asp:LinkButton ID="lnkSNFshow"   runat="server" OnClientClick = "return showSNFoneway();" 
                                             >SNF</asp:LinkButton>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Airline" SortExpression="OperatingAirlineName">
                                                            <ItemTemplate>
                                                                ...
                                                                <br />  <asp:Label ID="lblConnectingFlights" runat="server" Text="Connecting Flights..." Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Fare" SortExpression="Fare">
                                                            <ItemTemplate>
                                                                ...
                                                                <br />
                                                                 <asp:Label ID="lblHNFFare" runat="server" style="display:none;"   Font-Bold="true" CssClass ="clsFind"></asp:Label>
                                                                <br />
                                                                ...
                                                                <br />
                                                                <asp:Button ID="btnIntBookNow" runat="server"  CommandArgument='<%# Eval("FlightSegment_ID") %>'
                                                                    CommandName="BookTicket" OnClick="btnIntBookNow_Click" Text="Book Now"  CssClass="buttonBook"/>   <br />
                                                                            ...
                                                                            <table width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:Button ID="btnBookNowRoundTrip" runat="server" Text="Book Now" CommandName="BookTicket" CssClass="buttonBook"
                                                                                            CommandArgument='<%# Eval("OriginDestinationOption_Id") %>' />
