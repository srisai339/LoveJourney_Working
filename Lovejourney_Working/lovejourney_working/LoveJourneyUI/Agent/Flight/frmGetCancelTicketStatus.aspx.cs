...
using BAL;
public partial class Agent_Flight_frmGetCancelTicketStatus : System.Web.UI.Page
{
    ...
    protected void btnGet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (transId != "")
            {
                ...
                //dsCancelStatusResponse.ReadXml("F:\\Projects\\Love Journey\\Cancel_Domes tic_Static_Response.xml");
