...
public partial class Agent_Flight_frmDomesticAvailability : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    if (Session["DomesticFlighsAgentStatus"].ToString() != "0")
                    {
                    ...
                    {
                        lblStatus.Text = "This Service is temporarily unavaliable";
                  ...
                  if (mode == "ONE")
                  {
                      if (dtresponse.Columns.Count != 4)
                      {
                          if (dtresponse.Rows[0][1] == "")
                          {
                              ...
                              dtFareFlights.Columns.Add("Fare", typeof(double));
        ...
        try
        {
            if (Convert.ToInt32(ddlAdult.SelectedValue) + Convert.ToInt32(ddlChild.SelectedValue) + Convert.ToInt32(ddlInfant.SelectedValue) <= 9)
            {
                if (Convert.ToInt32(ddlInfant.SelectedValue) <= Convert.ToInt32(ddlAdult.SelectedValue))
                {
                    ...
                    dvModifySearch.Visible = false;//rajini changed true to false
    ...
    protected void gdvFlights_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        } if (e.CommandName == "View Details")
        {
            ...
            lbldurationdetails.Visible = true;
            ...
            if (drFlightNext[0]["adultTaxBreakUp"].ToString() == "0,0,0")
            {
                ...
                lbldurationdetails.Visible = false;
                #endregion
            ...
            {
                trlayovertime.Visible = false;
                trConnecting.Visible = false;
            }
            lnkDummy_Click(sender, e);
        }
        else if (e.CommandArgument == "ShowNetFares")
        {
            Control ctl = e.CommandSource as Control;
            GridViewRow row1 = ctl.NamingContainer as GridViewRow;
            if (lnkSNFFare.Text == "SNF")
            {
                lnkSNFFare.Text = "HNF";
              
                    Label lnkHNFFare = (Label)row1.FindControl("lblHNFFare");
                    lnkHNFFare.Visible = true;
    ...
    protected void rbnAirlineonward_CheckedChanged(object sender, EventArgs e)
    {
        ...
        Label lblSCharge = (Label)gdvFlightsrow.FindControl("lblSCharge");
        Label lblTDiscount = (Label)gdvFlightsrow.FindControl("lblTDiscount");
        Label lblTChargeonwardgv1 = (Label)gdvFlightsrow.FindControl("lblTChargeonwardgv");
        ...
        lblTChargeonwardtbl.Text = lblTChargeonwardgv1.Text;
        ...
        lblTchargeOnward.Text = lblTChargeonwardtbl.Text;
    ...
    protected void rbnAirlineReturn_CheckedChanged(object sender, EventArgs e)
    {
        ...
        Label lblSCharge = (Label)gdvFlightsrow.FindControl("lblSCharge");
        Label lblTDiscount = (Label)gdvFlightsrow.FindControl("lblTDiscount");
        Label lblTChargereturngv1 = (Label)gdvFlightsrow.FindControl("lblTChargereturngv");
        ...
        if (lblOnwardTotal.Text == "")
        {
            lblOnwardTotal.Text = "0";
        }
        lblTotalOnwardReturn.Text = (Convert.ToDouble(lblOnwardTotal.Text) + Convert.ToDouble(lblReturnTotal.Text)).ToString();
        ...
        lblTchargeReturntbl.Text = lblTChargereturngv1.Text;
        ...
        lblTchargeReturn.Text=  lblTChargereturngv1.Text;
    ...
    private DataTable GetFareDetTable(DataTable dtFlightsSegment, DataTable dtFareDet, DataSet dsFilghts)
    {
        ...
        dtNewFare.Columns.Add("Fare", typeof(double));
        foreach (DataRow dr in dtFlightsSegment.Rows)
        {
    ...
    private void CreateControls(int adultCnt, int ChildCnt, int infCnt)
    {
        try
        {
            ...
            for (int i = 1; i <= ChildCnt; i++)
            {
              ...
              //  txtBirthDate.Attributes.Add("onclick", "javascript:showDate2();");
    ...
    protected void btnBook_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dtChargeableFares.Rows.Count > 0)
            {
                ...
                TotalFare = (Convert.ToDecimal(actualBaseFare) + Convert.ToDecimal(tax) + Convert.ToDecimal(Stax) + Convert.ToDecimal(TCharge) + Convert.ToDecimal(TMarkup)).ToString();
                //Convert.ToDecimal(SCharge) + Convert.ToDecimal(TDiscount) +
    ...
    public static string[] GetAirportCodes(string prefixText)
    {
        try
        {
            ...
            string filteringquery = "CityName_ LIKE'" + prefixText + "%' or AirportCode_ LIKE '" + prefixText  + "%'";
    ...
    protected void gdvOnward_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                DataTable dtFlightsSegment = (DataTable)dsFilghts.Tables[9];
                //rajini
    ...
    protected void gdvReturn_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label lblHyphen = (Label)e.Row.FindControl("lblHyphen");
                Label airlinename = (Label)e.Row.FindControl("lblAirlineName");
                DataTable dtFlightsSegment = (DataTable)dsFilghts.Tables[9];//Session["DtReturnFlights"]
    ...
    protected void lnkSNFFare_Click(object sender, EventArgs e)
    {
        if (lnkSNFFare.Text == "SNF")
        {
            lnkSNFFare.Text = "HNF";
            foreach(GridViewRow item in gdvFlights.Rows)
            {
                Label lnkHNFFare = (Label)item.FindControl("lblHNFFare");
                lnkHNFFare.Visible = true;
            }
