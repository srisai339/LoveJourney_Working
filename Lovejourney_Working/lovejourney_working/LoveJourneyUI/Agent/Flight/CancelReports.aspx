<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CancelReports.aspx.cs" Inherits="Agent_Flight_CancelReports" %>
                                    ...
                                    <td align="left" width="1000">
                                        <table width="1000">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtname" Width="150" runat="server">
                                                    </asp:TextBox>
                                                </td>
                                                <td>
                                                    &nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlpagesize" Width="150" runat="server">
                                                            <asp:ListItem Value="ALL">ALL</asp:ListItem>
                                                ...
                                                <tr>
                                                    <td colspan="5" align="center">
                                                        <asp:Button ID="btnsearch" runat="server" Text="Search" ValidationGroup="true" OnClick="btnsearch_Click" CssClass="buttonBook"/>&nbsp;
                                                        <asp:Button ID="Button1" runat="server" Text="Reset" CausesValidation="false" OnClick="Button1_Click" CssClass="buttonBook"/>
                                                    </td>
                                                </tr>
                                        </table>
                                    </td>
                        ...
                        <td>
                            <asp:GridView ID="GvFlightsReports" Width="100%" runat="server" AutoGenerateColumns="False"
                                ...
                                <columns>
                                    ...
                                    <asp:TemplateField HeaderText="Travel Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="ArrivalAirportName"
                                    ...
                                    <asp:TemplateField HeaderText="Email ID" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="EmailAddress"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblEmailAddress" runat="server" Width="130px" Text='<%# Eval("EmailAddress") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Actual Fare" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="ActualBasefare"
                                        HeaderStyle-ForeColor="White" HeaderStyle-Width="70px" ControlStyle-Width="70px">
                                        <HeaderStyle HorizontalAlign="Center" ForeColor="White"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblActualBasefare" runat="server" Width="70px" Text='<%# Eval("ActualBasefare") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="lblactulafare" runat="server"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
