...
public partial class Agent_Recharge_Failure : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Status"] != null && Session["Status"].ToString() != null)
        {
            ...
            if (Session["errorcode"].ToString().Trim() == "102")
            {
                lblerror.Text = "Error No :" + "" + Session["errorcode"].ToString() + " ," + "Error Message :" +" "+ "Recharge failed.Please Contact Administrator.";
            }
