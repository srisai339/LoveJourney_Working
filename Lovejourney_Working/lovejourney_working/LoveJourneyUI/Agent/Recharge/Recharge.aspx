<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Recharge/MasterPage.master" 
    AutoEventWireup="true" CodeFile="Recharge.aspx.cs" Inherits="Agent_Recharge_Recharge" %>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtMobile" onkeypress="return isNumberEvt(event)" class="inp" runat="server"
                                                                TabIndex="1" ValidationGroup="mobile" MaxLength="10" OnTextChanged="txtMobile_TextChanged"
                                                                AutoPostBack="true"> </asp:TextBox><ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender15"
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtMobile"
                                                                ValidationGroup="mobile" ErrorMessage="Please enter mobile number" Display="None"></asp:RequiredFieldValidator>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtMobile"
                                                                ValidationGroup="mobile" ErrorMessage="Please enter valid mobile number" Display="None"
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            ...
                                                            <asp:CompareValidator ID="cmpProvider" runat="server" ControlToValidate="ddlProvider"
                                                                ...
                                                                ValidationGroup="mobile" Type="String" Operator="NotEqual"></asp:CompareValidator>
                                                            ...
                                                            <table width="450" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="100" align="left">
                                                                        <asp:TextBox ID="ddlMobilerechargeamount" class="inp" runat="server" ValidationGroup="mobile"
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlMobilerechargeamount"
                                                                            ValidationGroup="mobile" ErrorMessage="Please select Recharge Amount" Display="None"> </asp:RequiredFieldValidator>
                                                                        ...
                                                                        <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="ddlMobilerechargeamount"
                                                                            ...
                                                                            Type="Integer" ValidationGroup="mobile" ValueToCompare="0"></asp:CompareValidator>
                                                                    ...
                                                                    <td width="35" align="left">
                                                                        <asp:Button ID="btnMobileRecharge" runat="server" CssClass="buttonBook" Text="Proceed"
                                                                            ValidationGroup="mobile" TabIndex="4" CausesValidation="false"  visible="false"    OnClick="btnMobileRecharge_Click" />
                                                                            <asp:Button ID="btn1" runat="server" Text="Proceed" ValidationGroup="mobile"  CssClass="buttonBook"
                                                                            onclick="btn1_Click"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <ContentTemplate>
                                                        <table width="450" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr id="td6" runat="server" visible="false">
                                                             ...
                                                             <tr>
                                                        <td align="left" height="20" valign="middle">
                                                            <asp:LinkButton ID="lnkdatacardpop" runat="server" Text="Popular Recharges" ForeColor="Blue" OnClick="lnkdatacardpop_Click"
                                                               ></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="100" align="left">
                                                                                <asp:TextBox ID="ddlDatacardRechargeAmount" class="inp" runat="server" ValidationGroup="submit"
                                                                                    MaxLength="5" TabIndex="3" Width="150px">
                                                                                </asp:TextBox>
                                                        ...
                                                        <asp:Panel ID="panelagentdatacard" runat="server" Style="display: none; width: 525px;
                                                           ...
                                                           <asp:Panel ID="pnldatacard" runat="server" Style="display: none">
                                                            <asp:Button ID="btndatacardpop" runat="server" Text="OK" />
                                                        </asp:Panel>

                                                         <ajaxToolkit:ModalPopupExtender ID="mpedatacardpop" runat="server" PopupControlID="pnldatacardpop"
        BackgroundCssClass="modalBackground" OkControlID="imgpopulardata" TargetControlID="btndatacardpop">
    </ajaxToolkit:ModalPopupExtender>
                                       <asp:Panel ID="pnldatacardpop" runat="server" Style="display: none; width: 525px;
        height: 250px; color: Black;">
        <table width="525" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <td>
                                <table width="600" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="right" valign="middle">
                                            <asp:ImageButton ID="imgpopulardata" Width="26" Height="26" runat="server" ImageUrl="../../images/close_but.png" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <td align="center">
                                            <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="">
                                                    ...
                                                    <td valign="top" >
                                                        <table width="100%">
                                                            <tr align="left">
                                                                        ...
                                                                        <td align="left" class="style1" valign="middle" width="50%">
                                                                            <asp:DropDownList ID="ddlpopdatacard" runat="server" CausesValidation="true" 
                                                                                CssClass="i2s_jp_seats" TabIndex="4" Width="150px">
                                                                                <asp:ListItem Text="Please select" Value="0"></asp:ListItem>
                                                                            </asp:DropDownList>
                                                                            <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" 
                                                                                runat="server" CloseImageUrl="~/images/Closing.png" PopupPosition="Left" 
                                                                                TargetControlID="cvddlpopdatacard" WarningIconImageUrl="~/images/warning.png">
                                                                            </ajaxToolkit:ValidatorCalloutExtender>
                                                                            <asp:CompareValidator ID="cvddlpopdatacard" runat="server" 
                                                                                ControlToValidate="ddlpopdatacard" Display="None" 
                                                                                ErrorMessage="Please select Operator Name" Operator="NotEqual" Type="Integer" 
                                                                                ValidationGroup="POPData" ValueToCompare="0"></asp:CompareValidator>
                                                                            <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" 
                                                                                runat="server" CloseImageUrl="~/images/Closing.png" PopupPosition="Left" 
                                                                                TargetControlID="rfvddlpopdatacard" WarningIconImageUrl="~/images/warning.png">
                                                                            </ajaxToolkit:ValidatorCalloutExtender>
                                                                            <asp:RequiredFieldValidator ID="rfvddlpopdatacard" runat="server" 
                                                                                ControlToValidate="ddlpopdatacard" Display="None" 
                                                                                ErrorMessage="Please Select Operator Name" ValidationGroup="POPData"></asp:RequiredFieldValidator>
                                                                        </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td align="center" colspan="2" height="15" width="100%">
                                                                    <asp:Button ID="btnPOPData" runat="server" CssClass="buttonBook" 
                                                                        OnClick="btnPOPData_Click" TabIndex="17" Text="Show" 
                                                                        ValidationGroup="POPData" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="center" class="style1" colspan="3" valign="middle">
                                                        &nbsp;
                                                        <asp:Label ID="lblpopdata" runat="server" CssClass="labelconfirm" 
                                                            Font-Size="Medium" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr ID="tr2" runat="server" align="center">
                                                    <td colspan="4">
                                                        <asp:GridView ID="gvdatapop" runat="server" AllowPaging="True" 
                                                            AllowSorting="True" AlternatingRowStyle-CssClass="alt" 
                                                            AutoGenerateColumns="False" CellPadding="4" EnableModelValidation="True" 
                                                            ForeColor="#333333" GridLines="None" PagerStyle-CssClass="i2s_jp_bustext" 
                                                            PageSize="20" Width="70%">
