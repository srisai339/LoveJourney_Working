<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Recharge/MasterPage.master"
    AutoEventWireup="true" CodeFile="IndividualAgentReports.aspx.cs" Inherits="Agent_Recharge_IndividualAgentReports" %>
                ...
                <td colspan="5">
                    <asp:GridView ID="gvD2HRecharge" runat="server" AutoGenerateColumns="False" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Customer Num" DataField="Customer_ID" HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
