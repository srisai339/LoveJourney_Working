<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/Hotel/MasterPage.master"
    AutoEventWireup="true" CodeFile="Hotels.aspx.cs" Inherits="Agent_Hotel_Hotels"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <td width="100%" bgcolor="#fff" align="center">
                        ...
                        <asp:Panel ID="pnlModifySearch" runat="server">
                            <table width="980" border="0" cellspacing="0" cellpadding="0" class="is_tp">
                                <tr>
                                    <td width="5%" class="lj_hd" align="center" valign="middle">
                                        City:
                                    </td>
                                    ...
                                    <td valign="top">
                                        <asp:Button ID="btnModify" runat="server" ValidationGroup="modify" Text="Modify"
                                            CssClass="buttonBook" OnClick="btnModify_Click" OnClientClick="showDiv2();" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
        ...
        hoteldesc,facilities,webService,citywiselocation,locationinfo,checkintime,checkouttime,imagepath"
                                        ...
                                        <table width="100%" border="0" style="border-bottom: 0px;" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td align="left" width="178" valign="top">
                                                    ...
                                                    <br />
                                                    <br />
                                                    <span id="mainDiv1" style="display: none" class="loadingBackground"></span><span
                                                        id="contentDiv1" style="display: none" class="modalContainer">
                                                    ...
                                                    </span><span id="mainDiv" style="display: none" class="loadingBackground"></span>
                                                    <span id="contentDiv" style="display: none" class="modalContainer">
                                                        <div class="registerhead">
                                                            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                <tr>
                                                                    <td width="9" height="8">
                                                ...
                                                <td colspan="3">
                                                    <asp:Panel ID="pnlHotelRooms" runat="server" Visible="false">
                                                        ...
                                                        <asp:GridView ID="gvHotelRooms" BorderColor="GrayText" runat="server" AutoGenerateColumns="false"
                                                            ...
                                                            RowStyle-VerticalAlign="Middle" DataKeyNames="ratetype,hotelPackage,roomtype,roombasis,roomTypeCode,ratePlanCode,hotelid,validdays,wsKey,extGuestTotal,roomTotal,servicetaxTotal,discount,commission"
                                                            OnRowCommand="gvHotelRooms_RowCommand" OnRowDataBound="gvHotelRooms_RowDataBound">
                                                            <FooterStyle CssClass="link_buttons" />
                                                            <Columns>
                        ...
                        <div style="text-align: left; display: none;">
                            <asp:Button ID="btnPopId" runat="server" Height="1px" Width="1px" /></div>
