<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmIntFlightsAvailability.aspx.cs"
    MasterPageFile="~/MasterPage.master" Inherits="frmIntFlightsAvailability" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
   <style type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showSNFoneway() {
            if (document.getElementById("<%=lnkSNFshow.ClientID %>").text == "SNF") {
                document.getElementById("<%=lnkSNFshow.ClientID %>").text = "HNF";
                var con = $(".clsFind");
                con.show();
                return false;

            }
            else if (document.getElementById("<%=lnkSNFshow.ClientID %>").text == "HNF") {
                var con = $(".clsFind");
                con.hide();
                document.getElementById("<%=lnkSNFshow.ClientID %>").text = "SNF";
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showSNFtwoway() {
            if (document.getElementById("<%=lnkSNFshowroundtrip.ClientID %>").text == "SNF") {
                document.getElementById("<%=lnkSNFshowroundtrip.ClientID %>").text = "HNF";
                var con = $(".clsFind");
                con.show();
                return false;

            }
            else if (document.getElementById("<%=lnkSNFshowroundtrip.ClientID %>").text == "HNF") {
                var con = $(".clsFind");
                con.hide();
                document.getElementById("<%=lnkSNFshowroundtrip.ClientID %>").text = "SNF";
    ...
    <script type="text/javascript">
        ...
        function startsearch1() {
            ...
            document.getElementById('<%=hdnfromdate.ClientID %>').value = Date3;
            var Date4 = document.getElementById('<%=txtretundatesearch.ClientID %>').value;

            document.getElementById('<%=hdnTodate.ClientID %>').value = Date4;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <asp:HiddenField ID="hdnTodate" runat="server" />
    <asp:Panel ID="pnlflights" runat="server">
        <table width="1004" cellpadding="0" cellspacing="0" border="0" height="357">
            <tr>
                <td valign="top">
                    <table width="1004" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td width="1004" valign="middle" align="left" class="tr" id="tdmsg" runat="server"
                                visible="false">
          ...
          <tr>
            ...
            <td width="8"><img src="Newimages/l2.png" width="8" height="37" /></td>
                                                                ...
                                                                <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td align="left" class="lj_srchGo">
                                                                            Search your InterNational Flight Here
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td height="10">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <ajax:AutoCompleteExtender ID="txtFrom_AutoCompleteExtender" runat="server" TargetControlID="txtFrom"
                                                                                                            ServiceMethod="GetAirportCodes" MinimumPrefixLength="2" CompletionInterval="10"
                                                                                                            CompletionSetCount="12" FirstRowSelected="True" DelimiterCharacters="" Enabled="True"
                                                                                                            ServicePath="">
                                                                                                        </ajax:AutoCompleteExtender>
                                                                                                          <ajax:TextBoxWatermarkExtender ID="tbe" runat="server" WatermarkText="Enter Your Source" TargetControlID="txtFrom"></ajax:TextBoxWatermarkExtender>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <asp:TextBox ID="txtTo" runat="server" ToolTip="Type the first 3 letters of airport or city name"
                                                                                                            CssClass="lj_inputbox"  TabIndex="3"></asp:TextBox>
                                                                                                        ...
                                                                                                        <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" TargetControlID="rfvTo">
                                                                                                        </ajax:ValidatorCalloutExtender>
                                                                                                        <ajax:AutoCompleteExtender ID="txtTo_AutoCompleteExtender" runat="server" TargetControlID="txtTo"
                                                                                                         ...
                                                                                                         <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" WatermarkText="Enter Your Destination" TargetControlID="txtTo"></ajax:TextBoxWatermarkExtender>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="lj_outDiv">
                                                                                            <table width="233" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <asp:TextBox Width="100px" ID="txtIntDeptDate" ValidationGroup="Search" runat="server"
                                                                                                            onkeyup="return tabE(this,event)" onPaste="javascript: return false;" CssClass="datepicker1"
                                                                                                            OnClick="showDateInt();" TabIndex="4" />
                                                                                                       <%-- <asp:RequiredFieldValidator ID="rfvDepOn" ValidationGroup="SearchInt" runat="server"
                                                                                                        ...
                                                                                                        <%--<ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="rfvDepOn">
                                                                                                        </ajax:ValidatorCalloutExtender>--%>
                                                                                                        <ajax:TextBoxWatermarkExtender ID="txtwte" runat="server" TargetControlID="txtIntDeptDate" WatermarkText="DD-MM-YYYY"></ajax:TextBoxWatermarkExtender>
                                                                                                        &nbsp;
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                    ...
                                                                                    <td width="233" align="left" id="tdround" runat="server">
                                                                                        <div class="lj_outDiv">
                                                                                            <table width="233" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                <tr>
                                                                                                    <td width="70" align="center" class="lj_bdrit">
                                                                                                        <img src="images/calender.png" width="56" id="imgReturn" runat="server" height="32" />
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                        <asp:TextBox ID="txtIntReturnDate" Width="100px" runat="server" Enabled="False" Visible="true"
                                                                                                            TabIndex="4" ValidationGroup="SearchInt" onkeyup="return tabE1(this,event)" onPaste="javascript: return false;"
                                                                                                            CssClass="datepicker1" OnClick="showDateInt1();" />
                                                                                                      ...
                                                                                                      <%--  <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" TargetControlID="RequiredReturnInt">
                                                                                                         ...
                                                                                                         <ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="txtIntReturnDate" WatermarkText="DD-MM-YYYY"></ajax:TextBoxWatermarkExtender>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="lj_outDiv">
                                                                                            <table width="233" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <asp:DropDownList ID="ddlIntCabinType" CssClass="lj_inputdropdown" runat="server"
                                                                                                            TabIndex="9">
                                                                                    ...
                                                                                    <td width="100%" valign="top">
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                    ...
                                                                                                    <div class="lj_outroom">
                                                                                                        <table width="233" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlAdultsInt" runat="server" Width="50px" CssClass="lj_inputdropdown"
                                                                                                                        TabIndex="6">
                                                                                                    ...
                                                                                                    <div class="lj_outroom">
                                                                                                        <table width="233" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlChildsInt" runat="server" Width="50px" CssClass="lj_inputdropdown"
                                                                                                                        TabIndex="7">
                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="lj_outroom">
                                                                                                        <table width="70" border="0" cellspacing="0" cellpadding="0" height="39">
                                                                                                            <tr>
                                                                                                                <td width="70" align="center" class="lj_bdrit">
                                                                                                                    <img src="Newimages/child.png" width="56" height="32" />
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    <asp:DropDownList ID="ddlInfantsInt" runat="server" Width="50px" CssClass="lj_inputdropdown"
                                                                                                                        TabIndex="8">
                                                                                                                        <asp:ListItem Value="0">00</asp:ListItem>
                                                                                                                        <asp:ListItem Value="1">01</asp:ListItem>
                                                                                                                        <asp:ListItem Value="2">02</asp:ListItem>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:ImageButton ID="ibtnSearchInt" runat="server" TabIndex="10" ImageUrl="~/Newimages/serch.png"
                                                                                                        OnClick="ibtnSearchInt_Click" OnClientClick="return startsearch();" ValidationGroup="SearchInt" />
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td colspan="3" align="center" valign="top">
                                                                                                                        <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center">
                                                                                                                                    <img src="images/loading14.gif" width="37" height="38" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" height="20">
                                                                                                                                    <input id="Text4" type="text" style="border: 0; text-align: right; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                    To
                                                                                                                                    <input id="Text5" type="text" style="text-align: left; border: 0; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                    ...
                                                                                                    </span><span id="Span3" style="display: none" class="loadingBackground"></span><span
                                                                                                        id="Span4" style="display: none" class="modalContainer">
                                                                                                        <div class="registerhead">
                                                                                                            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color: White">
                                                                                                                <tr>
                                                                                                                    <td width="9" height="8">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td colspan="3" align="center" valign="top">
                                                                                                                        <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" height="20" class="lj_hd">
                                                                                                                                    <input id="Text28" type="text" style="text-align: right; border: 0; background-color: white;"
                                                                                                                                        readonly="readonly" class="progress" />
                                                                                                                                    &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                    <input id="Text29" type="text" style="text-align: left; border: 0; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" height="20" class="lj_hd">
                                                                                                                                    <input id="Text30" type="text" style="border: 0; text-align: center; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" height="20" class="lj_hd">
                                                                                                                                    <input id="Text31" type="text" style="text-align: right; border: 0; background-color: white;"
                                                                                                                                        readonly="readonly" class="progress" />
                                                                                                                                    &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                    <input id="Text32" type="text" style="text-align: right; border: 0; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                            <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" height="20" class="lj_hd">
                                                                                                                                    <input id="Text33" type="text" style="border: 0; text-align: center; background-color: White"
                                                                                                                                        disabled="disabled" class="progress" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                ...
                                <asp:Panel ID="InternationalFlightsPanel" runat="server">
                                    <table width="1004" style="" cellpadding="0" cellspacing="0" border="0" id="international"
                                        runat="server">
                                        <tr>
                                        ...
                                        <tr id="ModifySearch" runat="server" visible="false">
                                            <td align="center" width="970">
                                                <div id="dvModifySearch" visible="false" runat="server" style="padding-left: 1px;
                                                    padding-right: 3px; width: 970;">
                                                    <h3>
                                                        Modify Search</h3>
                                                    <asp:Panel ID="pnlModSearch" runat="server">
                                                      ...
                                                      <tr>
                                                        ...
                                                        <asp:RadioButton ID="rradiooneway" Text="One Way" runat="server" Checked="true" AutoPostBack="True" Font-Size="Medium"
                                                          ...
                                                          <td width="162" align="left" class="lj_hd" height="30">Leaving From :</td>
                                                          <td width="162" align="left"  class="lj_hd"> Leaving To :</td>
                                                          <td width="162" align="left" class="lj_hd"> Departure On :</td>
                                                          <td width="162" align="left" class="lj_hd"> <asp:Label ID="Label1" runat="server" Text="Return On :"></asp:Label></td>
                                                          ...
                                                          <td width="162">
                                                                ...
                                                                <asp:TextBox ID="txtleavingtosearch" runat="server" Width="110" ToolTip="Type the first 3 letters of airport or city name" ></asp:TextBox>
                                                          ...
                                                          <td width="175">
                                                           <asp:TextBox ID="txtretundatesearch" runat="server" Enabled="false" Width="70px" CssClass="datepicker1" 
                                                          ...
                                                          <td width="162" height="30" class="lj_hd">
                                                           Adult
                                                          </td>
                                                          <td width="175" class="lj_hd">
                                                          Child(2-11 Years)
                                                          </td>
                                                          <td width="175" class="lj_hd">
                                                          Infant(<2Years)
                                                ...
                                                <asp:DropDownList ID="ddlinfantsintsearch" runat="server" CssClass="lj_inp" Width="50">
                                                    ...
                                                    <asp:ListItem Value="8">08</asp:ListItem>
                                                          ...
                                                          <td width="162">
                                                         <asp:DropDownList ID="ddlIntCabinTypesearch"  CssClass="lj_inp" runat="server" Width="180px">
                                                                        <asp:ListItem Selected="True" Value="E">Economy Lowest Fare</asp:ListItem>
                                                                        <asp:ListItem Value="ER">Economy Refundable Fare</asp:ListItem>
                                                                        <asp:ListItem Value="B">Business / First Class</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                                        ...
                                                                                        <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center" height="20">
                                                                                                    ...
                                                                                                    &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                    <input id="Text2" type="text" style="border: 0;text-align:left; background-color:White" disabled="disabled" class="progress" />
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="center" height="20">
                                        ...
                                        <tr runat="server" id="trFilterSearch" visible="false">
                                            <td>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <table width="25%" style="border: 0px solid #657600;" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" class="lj_ms_bdr" align="center">
                                                                                ...
                                                                                <td colspan="2" align="center">
                                                                                    <table width="230" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="140">
                                                                                                <asp:TextBox ID="txtfromsearch" runat="server" ToolTip="Type the first 3 letters of airport or city name"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="140">
                                                                                                <asp:TextBox ID="txtleavingtosearch" runat="server" ToolTip="Type the first 3 letters of airport or city name"
                                                                                                    CssClass="lj_ms_in"></asp:TextBox>
                                                                                                <asp:RequiredFieldValidator ID="rfvtxtleavingtosearch" Display="None" ValidationGroup="SearchInt1"
                                                                                                    runat="server" ErrorMessage="Enter Destination" ControlToValidate="txtleavingtosearch"></asp:RequiredFieldValidator>
                                                                                                <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="rfvtxtleavingtosearch">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="140">
                                                                                                <asp:TextBox ID="txtretundatesearch" runat="server" Enabled="false" Width="90px"
                                                                                                    CssClass="datepicker1" Visible="true" ValidationGroup="SearchInt" onkeyup="return tabE3(this,event)"
                                                                                                    onPaste="javascript: return false;" OnClick="showDateInt();" />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="2" align="center">
                                                                                                <asp:ImageButton ID="imgsearch" runat="server" ImageUrl="~/images/check-availability-btn.jpg"
                                                                                                    CssClass="lj_ms_in" OnClick="imgsearch_Click" OnClientClick="return startsearch1();"
                                                                                                    ValidationGroup="SearchInt1" />
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" height="20">
                                                                                                        <input id="Text1" type="text" style="border: 0px; text-align: right; background-color: White;"
                                                                                                            class="progress" />
                                                                                                        &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                        <input id="Text2" type="text" style="border: 0px; background-color: White; text-align: left"
                                                                                                            class="progress" />
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                        ...
                                                                        </span><span id="mainDiv4" style="display: none" class="loadingBackground"></span>
                                                                        <span id="contentDiv4" style="display: none" class="modalContainer">
                                                                            <div class="registerhead">
                                                                                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color: White">
                                                                                    <tr>
                                                                                        <td width="9" height="8">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" id="trfiltersearch1" runat="server">
                                                                        <table cellpadding="0" cellspacing="0">
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" width="100%" colspan="3" class="lj_ms_bdr">
                                                        ...
                                                        <td align="center" style="width: 75%" id="oneway" runat="server" valign="top">
                                                            <table>
                                                                <tr>
                                                                    <td align="right">
                                                                        <asp:LinkButton ID="lnkSNFshow" runat="server" OnClientClick="return showSNFoneway();">SNF</asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                             <table width="90%">
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <asp:LinkButton ID="lnkDepart" runat="server" Text="Depart" ToolTip="ASC" OnClick="lnkDepart_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="10%">
                                                        <asp:LinkButton ID="lnkarrives" runat="server" Text="Arrives" ToolTip="ASC" OnClick="lnkarrives_Click"></asp:LinkButton>
                                                    </td>
                                                    <td width="35%" align="right">
                                                        <asp:LinkButton ID="lnkfare" runat="server" Text="Fare" ToolTip="ASC" OnClick="lnkfare_Click"></asp:LinkButton>
                                                    </td>
                                                </tr>
                                            </table>
                                                            <asp:GridView ID="gdvIntFlights" Width="90%" ShowHeader="false" runat="server" AutoGenerateColumns="false"
                                                                GridLines="Horizontal" AllowSorting="true" OnRowDataBound="gdvIntFlights_RowDataBound"
                                                                OnRowCommand="gdvIntFlights_RowCommand" PageSize="20" OnPageIndexChanging="gdvIntFlights_PageIndexChanging"
                                                                OnSorting="gdvIntFlights_Sorting">
                                                                <Columns>
                                                    ...
                                                    <asp:TemplateField Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAirlineNameMrk" runat="server" Text='<%# Eval("OperatingAirlineName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField ItemStyle-Width="93%">
                                                            ...
                                                            <asp:GridView GridLines="None" ID="gdvconnectingflights" CellPadding="1" CellSpacing="0"
                                                                ...
                                                                <Columns>
                                                                 <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        ...
                                                                        <ItemTemplate>
                                                                          <asp:Label ID="lblflttime"  runat ="server" Text='<%# Eval("FltTm") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Airline" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="20%"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lblOperatingAirlineFlightNumber" runat="server" Text='<%# Eval("OperatingAirlineFlightNumber") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    
                                                                    <asp:TemplateField HeaderText="Departs" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="28%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="28%" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDeparts" runat="server" Text='<%# Eval("DepartureDateTime") %>'></asp:Label><br />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Arrival" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="24%"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblArrives" runat="server" Text='<%# Eval("ArrivalDateTime") %>'></asp:Label>
                                                                            <br />
                                                                    ...
                                                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkNoofstops" runat="server" Text='<%# Eval("NumStops") %>' Font-Overline="false"></asp:LinkButton>
                                                                            <asp:Label ID="lblviaflight" runat="server" Font-Bold="true" Text=''
                                                     ...
                                                     <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        HeaderStyle-HorizontalAlign="Left" >
                                                                        <ItemTemplate>
                                                                          <asp:Label ID="lbljrnytime"  runat ="server" Text='<%# Eval("jrnyTm") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                              <asp:Label ID="lblFare" runat="server" Text='<%# Eval("Fare") %>' Font-Bold="true" CssClass="lj_fare"></asp:Label>
                                                              <br />
                                                                            <asp:Label ID="lblHNFFare" runat="server" Style="display: none;" Font-Bold="true"
                                                                                ></asp:Label><br />
                                                                                <asp:Label ID="lblOnewayAgentcomm" runat="server" Style="display: none;font-weight:bold;font-size:16px;color:#CC006E;" Font-Bold="true"
                                                            ...
                                                            <asp:Button ID="btnIntBookNow" runat="server" CssClass="buttonBook" CommandArgument='<%# Eval("FlightSegment_ID") %>'
                                                                                CommandName="BookTicket" OnClick="btnIntBookNow_Click" Text="Book Now" />
                                                            <br />
                                                           <asp:LinkButton ID="lnkFareDetails" runat="server" Font-Underline="false">Fare Details</asp:LinkButton>
                                                                            <ajax:HoverMenuExtender ID="HoverMenuExtender2" runat="server" OffsetX="30" OffsetY="-100"
                                                                                PopupControlID="pnlFareDetails" PopupPosition="Left" TargetControlID="lnkFareDetails">
                                                                            </ajax:HoverMenuExtender>
                                                                   ...
                                                                   <%-- <asp:TemplateField HeaderText="Airline" SortExpression="OperatingAirlineName">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lblConnectingFlights" runat="server" Text="Connecting Flights..."
                                                                                Visible="false"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Departs" SortExpression="DepartureDateTime">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDeparts" runat="server" Text='<%# Eval("DepartureDateTime") %>'
                                                                                Font-Bold="true"></asp:Label>
                                                                            <asp:Label ID="lbldepartdate" runat="server" Visible="false" Text='<%# Eval("DepartureDateTime") %>'></asp:Label>
                                                                            <asp:Label ID="lblFlightSegment_ID" runat="server" Text='<%# Eval("FlightSegment_ID") %>'
                                                                                Visible="false"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                            ...
                                                            <asp:Panel ID="pnlAirlineDetails" runat="server" Style="position: fixed; top: 0px;
                                                                ...
                                                                <table width="600" bgcolor="#eefaff" style="border: #222 5px solid;" height="100">
                                                                    ...
                                                                    <tr runat="server" id="trConnecting1">
                                                                        <td>
                                                                    ...
                                                                    <tr runat="server" id="trConnecting2">
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lblDepartureAirportNameDet2" runat="server"></asp:Label><br />
                                                                            <asp:Label ID="lblDepartureDateTimeDet2" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td width="75%" id="trroundTrip1" runat="server" visible="false" valign="top">
                                                                    ...
                                                                    <td style="width: 100%">
                                                                        <table>
                                                                            <tr>
                                                                                <td align="right" width="100%">
                                                                                    <asp:LinkButton ID="lnkSNFshowroundtrip" runat="server" OnClientClick="return showSNFtwoway();">SNF</asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <table width="100%">
                                                                       ...
                                                                       &nbsp;
                                                                        ...
                                                                        <asp:LinkButton ID="lnkdepartonward" runat="server" Text="Depart" ToolTip="ASC" OnClick="lnkdepartonward_Click"></asp:LinkButton>
                                                                         ...
                                                                         <td width="40%">
                                                                        <asp:LinkButton ID="lnkarriveonward" runat="server" Text="Arrives" ToolTip="ASC" OnClick="lnkarriveonward_Click"></asp:LinkButton>
                                                                        </td>
                                                                         <td width="25%">
                                                                        <asp:LinkButton ID="lnkfareroudwayn" runat="server" Text="Fare" ToolTip="ASC" OnClick="lnkfareroudwayn_Click"></asp:LinkButton>
                                                                        </td>
                                                                        </tr>
                                                                        </table>
                                                                        <asp:Label ID="lblOriginDestinationRoundTrip" runat="server" Text="" Visible="false"></asp:Label>
                                                                        <asp:GridView ID="gdvRoundtrip" Width="99%" runat="server" AutoGenerateColumns="False" 
                                                                        ShowHeader="false"    OnRowDataBound="gdvRoundtrip_RowDataBound" OnRowCommand="gdvRoundtrip_RowCommand">
                                                                            <Columns>
                                                                            <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                             <asp:Label ID="lblOriginDestiantionOptionid" Visible="false" runat="server" Text='<%# Eval("OriginDestinationOption_Id") %>'></asp:Label>
                                                                                ...
                                                                                <asp:TemplateField>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <td>
                                                                                        <asp:GridView GridLines="None" ID="gdvonwardconnectingflights" CellPadding="1" CellSpacing="0"
                                                                OnRowDataBound="gdvconnectingonwardflights_RowDataBound" runat="server" AutoGenerateColumns="false"
                                                                Width="93%" CssClass="gridLines">
                                                                <Columns>
                                                                 <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        HeaderStyle-HorizontalAlign="Left" Visible="false">
                                                                      ...
                                                                      <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Image ID="imgonward" runat="server"  />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Departs" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="28%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="28%" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                         <asp:Label ID="lblOnwardDepartstime" runat="server" Text='<%# Eval("DepartureDateTime") %>'></asp:Label><br />
                                                                            <asp:Label ID="lblOnwardDeparts" runat="server" Text='<%# Eval("DepartureDateTime") %>'></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Arrival" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="24%"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lblOnwardArrivestime" runat="server" Text='<%# Eval("ArrivalDateTime") %>'></asp:Label>
                                                                             <br />
                                                                            <asp:Label ID="lblOnwardArrives" runat="server" Text='<%# Eval("ArrivalDateTime") %>'></asp:Label>
                                                         ...
                                                         <asp:Label ID="lblheading" runat="server" Text="Return Flights" ForeColor="Blue"></asp:Label>
                                                            <asp:GridView GridLines="None" ID="gdvreturnconnectingflights" CellPadding="1" CellSpacing="0"
                                                                OnRowDataBound="gdvreturnconnectingflights_RowDataBound" runat="server" AutoGenerateColumns="false"
                                                                Width="93%" CssClass="gridLines">
                                                                <Columns>
                                                                 <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        HeaderStyle-HorizontalAlign="Left" Visible="false">
                                                                ...
                                                                <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%"
                                                                        HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Image ID="imgreturn" runat="server"  />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Airline" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="20%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Left">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Departs" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="28%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="28%" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                          <asp:Label ID="lblReturnDepartstime" runat="server" Text='<%# Eval("DepartureDateTime") %>'></asp:Label>
                                                                          <br />
                                                                            <asp:Label ID="lblReturnDeparts" runat="server" Text='<%# Eval("DepartureDateTime") %>'></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Arrival" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="24%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="24%" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                         <asp:Label ID="lblReturnArrivestime" runat="server" Text='<%# Eval("ArrivalDateTime") %>'></asp:Label>
                                                                         <br />
                                                                            <asp:Label ID="lblReturnArrives" runat="server" Text='<%# Eval("ArrivalDateTime") %>'></asp:Label>                                                                          
                                                                            <br />
                                                                            <asp:Label ID="lblArrivalAirportCode" runat="server" Text='<%# Eval("ArrivalAirportCode") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Duration" HeaderStyle-CssClass="lj_Headerstyle" ItemStyle-Width="10%"
                                                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblReturnDuration" runat="server" Font-Bold="true"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                                ...
                                                                                <table width="300">
                                                                                    ...
                                                                                    <tr>
                                                                                       ...
                                                                                       <%--     <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:Label ID="lblTotalPrice" runat="server" Text="" Font-Bold="true"></asp:Label><br />
                                                                                                    <asp:Label ID="lblHNFFareRoundtrip" runat="server" Style="display: none;" Font-Bold="true"
                                                                                                        CssClass="clsFind"></asp:Label>
                                                                                                    <br />
                                                                                                    <asp:Button ID="btnBookNowRoundTrip" runat="server" Text="Book Now" CommandName="BookTicket"
                                                                                                        CssClass="buttonBook" CommandArgument='<%# Eval("OriginDestinationOption_Id") %>' />
                                                                                                    <asp:LinkButton ID="lnkDetails" runat="server" CommandName="View Details" CommandArgument='<%# Eval("OriginDestinationOption_Id") %>'
                                                                                                        OnClick="lnkDummyRound_Click">Details</asp:LinkButton>
                                                                                                    <br />
                                                                                                    <asp:LinkButton ID="lnkFareDet" runat="server" Font-Underline="false">Fare Details</asp:LinkButton>
                                                                                                    <ajax:HoverMenuExtender ID="HoverMenuExtender2" runat="server" TargetControlID="lnkFareDet"
                                                                                                        OffsetX="30" PopupPosition="Left" OffsetY="-100" PopupControlID="pnlFareDetails">
                                                                        ...
                                                                        <ajax:ModalPopupExtender ID="mpeAirlineDetOnward" runat="server" PopupControlID="pnlAirlineDetailsonward"
                                                                            TargetControlID="lnkDummyOnward" X="350" Y="250" BackgroundCssClass="modalBackground"
                                                                            OkControlID="btnokonward">
                                                                        </ajax:ModalPopupExtender>
                                                                        <asp:Panel ID="pnlAirlineDetailsonward" runat="server" Style="position: fixed; top: 0px;
                                                                            left: 0px; display: none; border: background:url(images/overlay1.png); width: 600;
                                                                            height: 200; padding-top: 10px; text-align: center; z-index: 1; padding-left: 10px;
                                                                            padding-right: 10px; padding-right: 10px" align="center">
                                                                            <table width="600" bgcolor="#eefaff" style="border: #222 5px solid;" height="100">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDetonward" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDetonward" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr runat="server" id="trConnecting1onward" visible="false">
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDet1onward" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDet1onward" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr runat="server" id="trConnecting2onward" visible="false">
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDet2onward" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDet2onward" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDetreturn" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDetreturn" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr runat="server" id="trConnecting1return" visible="false">
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDet1return" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDet1return" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr runat="server" id="trConnecting2return" visible="false">
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lblDepartureAirportNameDet2return" runat="server"></asp:Label><br />
                                                                                        <asp:Label ID="lblDepartureDateTimeDet2return" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" colspan="4">
                                                                                        <asp:Button ID="btnokonward" runat="server" Text="Ok" CssClass="buttonBook" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </asp:Panel>
                                            ...
                                            <td width="100%" valign="top">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding: 5px;">
                                                    ...
                                                    <tr>
                                                        <td height="30px">
                                                            ...
                                                            <asp:TextBox ID="txtMobileNumInt" runat="server" MaxLength="10" CssClass="lj_inp"
                                                                onchange="javascript:txttextchanged();"></asp:TextBox>&nbsp; (Will be contacted
                                                ...
                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding: 5px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top">
                                                            <asp:TextBox ID="txtConfirmEmailInt" runat="server" CssClass="lj_inp"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfvtxtConfirmEmailInt" runat="server" ErrorMessage="Enter Confirm Email ID"
                                                                Display="None" ValidationGroup="SubmitBook" ControlToValidate="txtConfirmEmailInt"></asp:RequiredFieldValidator>
                                                            <ajax:ValidatorCalloutExtender ID="VceInterEmail" runat="server" TargetControlID="rfvtxtConfirmEmailInt">
                                                            </ajax:ValidatorCalloutExtender>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <asp:Button ID="btnIntBookRoundTrip" runat="server" CssClass="buttonBook" Text="Submit"
                                                                Visible="false" OnClick="btnIntBookRoundTrip_Click" ValidationGroup="SubmitBook"/>
    ...
    <asp:Panel ID="pnl" runat="server" Style="position: fixed; top: 0px; left: 0px; display: none;
        border: background:url(images/overlay1.png); width: 100; height: 200; padding-top: 10px;
        text-align: center; z-index: 1;">
        <table width="300" bgcolor="#c7dafa" style="border: #222 5px solid;" height="100">
            <tr>
                <td>
                    &nbsp;
                </td>
