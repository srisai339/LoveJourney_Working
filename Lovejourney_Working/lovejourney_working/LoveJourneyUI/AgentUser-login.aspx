<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AgentUser-login.aspx.cs" Inherits="AgentUser_login" %>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr>
    ...
    <td align="center" valign="middle" class="online_booking">User Login</td>
  </tr>
</table>
                                    </td>
                                </tr>
     ...
     <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="28" align="left">
                                       <asp:TextBox ID="txtUserName" runat="server" CssClass="lj_inp" MaxLength="50" ></asp:TextBox>
                            ...
                            <ajax:ValidatorCalloutExtender ID="vcerfv2" runat="server" 
                                ...
                                <tr>
                                  ...
                                  Password
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtUserPassword" runat="server" CssClass="lj_inp" MaxLength="50" 
                                TextMode="Password"  />
                          <%--  <asp:RequiredFieldValidator ID="rfvUserPassword" runat="server" 
                                ControlToValidate="txtUserPassword" Display="None" ErrorMessage="Enter Password" 
                                ValidationGroup="submit1" />
                            <ajax:ValidatorCalloutExtender ID="vcerfv1" runat="server" 
                                TargetControlID="rfvUserPassword">
                            </ajax:ValidatorCalloutExtender>--%>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td  height="40"  valign="middle"  align="center" colspan="3">
                                       <asp:Button ID="btnUserLog" runat="server" Text="Submit" CssClass="buttonBook" 
                                                                                ValidationGroup="submit1" onclick="btnUserLog_Click"  
                                             />
                                    ...
                                    <tr>
                                        <td  height="40"  valign="middle"  align="center" colspan="3">
                                      <asp:LinkButton ID="lbtnNewUser" runat="server" Text="New User" onclick="lbtnNewUser_Click" 
                                                 ></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                       <asp:LinkButton ID="lnkUserForget" runat="server" Text="Forgot password?" PostBackUrl="~/ForgotPassword.aspx"></asp:LinkButton>
                                       </td>
  ...
  <tr>
    <td width="50"><img src="images/agent_reg.png"  width="37" height="37" /></td>
    <td align="center" valign="middle" class="online_booking">Agent Login</td>
  </tr>
</table>
                                    </td>
                                </tr>
     ...
     <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="28" align="left">
                                       <asp:TextBox ID="txtAgentName" runat="server" CssClass="lj_inp" MaxLength="50" />
                            <asp:RequiredFieldValidator ID="rfvAgentName" runat="server" 
                                ControlToValidate="txtAgentName" Display="None" ErrorMessage="Enter AgentName" 
                                ValidationGroup="submit2" />
                            <ajax:ValidatorCalloutExtender ID="vceAgentName" runat="server" 
                                TargetControlID="rfvAgentName">
                            </ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                                <tr>
                                  ...
                                  Password
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtAgentPassword" runat="server" CssClass="lj_inp" 
                                              MaxLength="50"  AutoPostBack="true" 
                                TextMode="Password" ontextchanged="txtAgentPassword_TextChanged" />
                            <asp:RequiredFieldValidator ID="rfvAgentPassword" runat="server" 
                                ControlToValidate="txtAgentPassword" Display="None" ErrorMessage="Enter Password" 
                                ValidationGroup="submit2" />
                            <ajax:ValidatorCalloutExtender ID="vceAgentPassword" runat="server" 
                                TargetControlID="rfvAgentPassword">
                            </ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td  height="40"  valign="middle"  align="center" colspan="3">
                                       <asp:Button ID="btnAgentLogin" runat="server" Text="Submit" CssClass="buttonBook"
                                                                                ValidationGroup="submit2" onclick="btnAgentLogin_Click" 
                                            />
                                 ...
                                 <tr>
                                        <td  height="40"  valign="middle"  align="center" colspan="3">
                                      <asp:LinkButton ID="lnkNewagent" runat="server" Text="New Agent" onclick="lnkNewagent_Click" 
                                                ></asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                       <asp:LinkButton ID="LinkButton4" runat="server" Text="Forgot password?" PostBackUrl="~/ForgotPassword.aspx"></asp:LinkButton>
                                       </td>
     ...
     <tr>
                                    ...
                                    <td height="28" align="left">
                                       <asp:TextBox ID="txtName" MaxLength="50" runat="server" CssClass="lj_inp"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtName"
                                                                                Display="None" ErrorMessage="Please enter your name." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                    ...
                                    <td height="28" align="left">
                                         <asp:TextBox ID="txtEmailId" MaxLength="500" runat="server" CssClass="lj_inp"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmailId"
                                                                                Display="None" ErrorMessage="Please enter your email id." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                ...
                                <tr>
                                   ...
                                   User Name
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtUserName1" runat="server" CssClass="lj_inp" MaxLength="500"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtUserName1"
                                                                                Display="None" ErrorMessage="Please Enter User Name." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                    ...
                                    <td height="28" align="left">
                                           <asp:TextBox ID="txtPassword" runat="server" CssClass="lj_inp" MaxLength="500" TextMode="Password"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtPassword"
                                                                                Display="None" ErrorMessage="Please Enter Password." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="RequiredFieldValidator7"></ajax:ValidatorCalloutExtender>
                                    ...
                                    <td height="28" align="left">
                                           <asp:TextBox ID="txtconfirmPassword" runat="server" CssClass="lj_inp" MaxLength="500" TextMode="Password"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtconfirmPassword"
                                                                                Display="None" ErrorMessage="Please Enter Confirm  Password." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" TargetControlID="RequiredFieldValidator8"></ajax:ValidatorCalloutExtender>
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtMobileNo" runat="server" CssClass="lj_inp" MaxLength="10"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtMobileNo"
                                                                                Display="None" ErrorMessage="Please enter mobile no." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                          ...
                                                                          <ajax:FilteredTextBoxExtender ID="fteMobilenos" runat="server" ValidChars="0123456789" TargetControlID="txtMobileNo"></ajax:FilteredTextBoxExtender>
                                    </td>
                                </tr>
                                    ...
                                    <td height="28" align="left">
                                           <asp:TextBox ID="txtAddress" runat="server" CssClass="lj_inp"  MaxLength="100"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtAddress"
                                                                                Display="None" ErrorMessage="Please Enter Address." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtCity" runat="server" CssClass="lj_inp"  MaxLength="100"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtCity"
                                                                                Display="None" ErrorMessage="Please Enter City Name." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                                <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" TargetControlID="RequiredFieldValidator9" runat="server"></ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                ...
                Country
                                    ...
                                    <td height="35" align="left">
                                          <asp:DropDownList ID="ddlcountry" runat="server" ValidationGroup="Submit" CssClass="lj_inp">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddlcountry"
                                                                                ...
                                                                                ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender6" runat="server" TargetControlID="RequiredFieldValidator10"></ajax:ValidatorCalloutExtender>
                                    </td>
                                </tr>
                   ...
                   Pin Code
                                    ...
                                    <td height="28" align="left"  valign="bottom">
                                         <asp:TextBox ID="txtPinCode" MaxLength="50" runat="server" CssClass="lj_inp"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtPinCode"
                                                                                Display="None" ErrorMessage="Please Enter Pincode." ValidationGroup="Submit3"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender id="ValidatorCalloutExtender7" runat="server" TargetControlID="RequiredFieldValidator11"></ajax:ValidatorCalloutExtender>
                                 ...
                                 <tr>
                                    ...
                                    <td  height="40"  valign="middle"  align="center" colspan="3">
                                       <asp:Button ID="btnUser" runat="server" Text="Submit" CssClass="buttonBook"
                                                                                ValidationGroup="Submit3" 
                                            onclick="btnUser_Click1" />&nbsp;&nbsp;
                                          <asp:Button ID="btnUserCancel" runat="server" Text="Cancel" 
                                            CssClass="buttonBook" CausesValidation="false" onclick="btnUserCancel_Click" />
    ...
    <td align="center" valign="middle" class="online_booking">Agent Registration</td>
     ...
     <tr>
                                ...
                                <tr>
                                    ...
                                    <td height="28" align="left">
                                       <asp:TextBox ID="txtAgentName1" MaxLength="50" runat="server" CssClass="lj_inp"
                                                                                 />
                                                                            <asp:RequiredFieldValidator ID="rfvAgentName1" runat="server" ControlToValidate="txtAgentName1"
                                                                                Display="None" ErrorMessage="Please enter your name." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender id="ValidatorCalloutExtender1" runat="server" TargetControlID="rfvAgentName1"></ajax:ValidatorCalloutExtender>
                                                                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID = "txtAgentName1" ValidChars="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ "></ajax:FilteredTextBoxExtender>
                                ...
                                <tr>
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtAgentEmail" MaxLength="500" runat="server" CssClass="lj_inp"
                                                                                 />
                                                                            <asp:RequiredFieldValidator ID="rfvAgentEmail" runat="server" ControlToValidate="txtAgentEmail"
                                                                                Display="None" ErrorMessage="Please enter your email id." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server" TargetControlID="rfvAgentEmail"></ajax:ValidatorCalloutExtender>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtAgentEmail"
                                                                                Display="Dynamic" ErrorMessage="Please enter correct email id." ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                                                                ValidationGroup="Submit4"></asp:RegularExpressionValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" TargetControlID="RegularExpressionValidator3"></ajax:ValidatorCalloutExtender>
                                 ...
                                 Organization
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtOrganization" runat="server" CssClass="lj_inp" MaxLength="500"
                                                                                ></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="rfvAgentorganization" runat="server" ControlToValidate="txtOrganization"
                                                                                Display="None" ErrorMessage="Please type of organization." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender9" runat="server" TargetControlID="rfvAgentorganization"></ajax:ValidatorCalloutExtender>
                           ...
                           Mobile No
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtAgentMobilno" runat="server" CssClass="lj_inp" 
                                              MaxLength="10" 
                                                                               ></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="rfvAgentMobile" runat="server" ControlToValidate="txtAgentMobilno"
                                                                                Display="None" ErrorMessage="Please enter mobile no." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender10" runat="server" TargetControlID="rfvAgentMobile"></ajax:ValidatorCalloutExtender>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtAgentMobilno"
                                                                                Display="None" ErrorMessage="Please enter valid mobile no." ValidationGroup="Submit4"
                                                                                ValidationExpression="[7-9][0-9]{9}"></asp:RegularExpressionValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender11" runat="server" TargetControlID="RegularExpressionValidator4"></ajax:ValidatorCalloutExtender>
                                                                            <ajax:FilteredTextBoxExtender ID="fte" runat="server" TargetControlID="txtAgentMobilno" ValidChars="0123456789"></ajax:FilteredTextBoxExtender>
                          ...
                          City
                                    ...
                                    <td height="28" align="left">
                                           <asp:TextBox ID="txtAgentCity" runat="server" CssClass="lj_inp" MaxLength="100" 
                                                                                
                                               ></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="rfvAgentCity" runat="server" ControlToValidate="txtAgentCity"
                                                                                Display="None" ErrorMessage="Please enter city name." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                                <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender12" TargetControlID="rfvAgentCity" runat="server"></ajax:ValidatorCalloutExtender>
                                    ...
                                    <td height="28" align="left">
                                           <asp:TextBox ID="txtDistrict" runat="server" CssClass="lj_inp" MaxLength="100"
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvDistrict" runat="server" ControlToValidate="txtDistrict"
                                                                                Display="None" ErrorMessage="Please enter district name." ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                                <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender13" TargetControlID="rfvDistrict" runat="server"></ajax:ValidatorCalloutExtender></td>
                                </tr>
                     ...
                     State
                                    ...
                                    <td height="28" align="left">
                                           <asp:DropDownList ID="ddlAgentState" runat="server" CssClass="lj_inp">
                                                                                <asp:ListItem>Please Select</asp:ListItem>
                                                                                <asp:ListItem>Andaman and Nicobar Islands</asp:ListItem>
                                                                                <asp:ListItem>Andhra Pradesh</asp:ListItem>
                                                                                <asp:ListItem>Arunachal Pradesh</asp:ListItem>
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="rfvAgentState" runat="server" ControlToValidate="ddlAgentState"
                                                                                Display="None" ErrorMessage="Please select state." InitialValue="Please Select"
                                                                                ValidationGroup="Submit4"></asp:RequiredFieldValidator>
                                                                            <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender14" runat="server" TargetControlID="rfvAgentState"></ajax:ValidatorCalloutExtender>
                      ...
                      Comments
                                    ...
                                    <td height="28" align="left">
                                          <asp:TextBox ID="txtComments" runat="server" CssClass="lj_inp" TextMode="MultiLine" Width="140"
                                                                                ></asp:TextBox>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td  height="40"  valign="middle"  align="center" colspan="3">
                                       <asp:Button ID="btnSignIn" runat="server" Text="Submit" CssClass="buttonBook"
                                        ...
                                        <asp:Button ID="btnAgentcancel" runat="server" Text="Cancel" 
                                            CausesValidation="false"  CssClass="buttonBook" onclick="btnAgentcancel_Click"/>
