<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CancelTicket.aspx.cs" Inherits="CanclTicket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="100%" height="30px" valign="middle" class="tr" id="tdmsg" runat="server"
                visible="false" colspan="2" align="center">
            ...
            <td valign="top" align="center">
                <asp:Panel ID="pnlcancel" Width="801" runat="server" DefaultButton="btnSignIn">
                    <table width="801" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <td colspan="2" align="left">
                                <%--<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="left" height="34" width="60%" valign="top">
                                            <asp:TextBox ID="txtMBRefNo" MaxLength="50" runat="server" CssClass="textfield_sleep" />
                                            <asp:RequiredFieldValidator ID="rfvUsername" ErrorMessage="Please Enter Ref No."
                                                ControlToValidate="txtMBRefNo" Display="None" runat="server" ValidationGroup="signin" />
                                            <ajax:ValidatorCalloutExtender ID="vceRefNo" runat="server" TargetControlID="rfvUsername"></ajax:ValidatorCalloutExtender>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" width="60%" valign="top">
                                            ...
                                            <asp:TextBox ID="txtEmailID" runat="server" CssClass="textfield_sleep" 
                                                MaxLength="50" Visible="false" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ControlToValidate="txtEmailID" Display="None" ErrorMessage="Enter Email ID" />
                                ...
                                <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" height="20" align="left">
                                                        <table width="347" height="45" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td width="50">
                                                                    <img src="images/cancel_tick.png" width="37" height="37" />
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td height="40" valign="middle" align="center" colspan="3">
                                                                    <asp:Button ID="btnSignIn" runat="server" Text="Submit" CssClass="buttonBook" ValidationGroup="signin"
                                                                        OnClick="btnSignIn_Click" OnClientClick="showDiv();" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="40" valign="middle" align="left" colspan="3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_bottom" width="347">
                                        </td>
                            ...
                            <td colspan="2" align="center">
                                <asp:GridView ID="gvPartialCancellation" AutoGenerateColumns="False" runat="server"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkSelectAll" Text="All" runat="server" Checked="true" AutoPostBack="true"
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnConfrmCancel" Text="Confirm To Cancel" runat="server" CssClass="buttonBook"
