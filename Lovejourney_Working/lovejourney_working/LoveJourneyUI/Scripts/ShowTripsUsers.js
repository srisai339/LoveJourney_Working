function LoadDestinations() {
    ...
    $.ajax(
                {
                    type: "POST",
                    url: "../../Users/Bus/Show_Trips.aspx/GetDestinations",
                    data: "{sourceId: '" + ddl + "'}",
...
function LoadRoutes(evt, arg) {
    ...
    $.ajax(
                {
                    type: "POST",
                    url: "../../Users/Bus/Show_Trips.aspx/GetRoutes",
...
function LoadSeatLayout(evt, arg) {
    ...
    $.ajax(
                {
                    type: "POST",
                    url: "../../Users/Bus/Show_Trips.aspx/GetSeatLayout",
                    data: "{args: '" + arg + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    async: true,
...
function fnGetCancellation(arg) {
    ...
    $.ajax({
        type: "POST",
        url: "../../Users/Bus/Show_Trips.aspx/GetCancellationPolicy",
...
function fnGetPoints(arg, element) {
    ...
    var timer = setTimeout(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../Users/Bus/Show_Trips.aspx/GetPoints",
