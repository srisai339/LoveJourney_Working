...
public partial class CarTicket : System.Web.UI.Page
{
    ...
    private void BindTicketDetails()
    {
        ...
        dsFlights = objFlightsBAL.GetCarDetaisl(Session["refno"].ToString(),Session["CardetailsId"].ToString());
        if (dsFlights.Tables[0].Rows.Count > 0)
        {
            ...
            lblTotalFare.Text = dsFlights.Tables[0].Rows[0]["TotalFare"].ToString();
