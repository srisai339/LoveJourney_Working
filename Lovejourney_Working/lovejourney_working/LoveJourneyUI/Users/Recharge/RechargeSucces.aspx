<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Recharge/MasterPage.master"
    AutoEventWireup="true" CodeFile="RechargeSucces.aspx.cs" Inherits="Users_Recharge_RechargeSuccess" %>
                                ...
                                <tr>
                                    <td class="test" valign="middle" colspan="3" align="center" height="30">
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text="Please Click Here To check the status"
                                            PostBackUrl="~/Users/Recharge/RechargeStatus.aspx" ForeColor="Black" OnClick="LinkButton1_Click"></asp:LinkButton>
                                    </td>
