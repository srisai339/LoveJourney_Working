<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Flight/MasterPage.master" AutoEventWireup="true" CodeFile="frmCancelTicketStatus.aspx.cs" Inherits="Users_Flight_frmCancelTicketStatus" %>
                ...
                <div>
                    <asp:Panel ID="pnlBookingStatus" runat="server">
                        <table>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:Button ID="btnGet" runat="server" Text="Get Status" OnClick="btnGet_Click" 
                                        ValidationGroup="signin" CssClass="buttonBook" />
                                      <asp:Button ID="btnGetInt" runat="server" Text="Get Status" 
