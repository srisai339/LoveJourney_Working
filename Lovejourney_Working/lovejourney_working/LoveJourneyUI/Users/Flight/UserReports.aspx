<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="UserReports.aspx.cs" Inherits="Users_Flight_UserReports" %>
                                    ...
                                    <td align="center" width="600">
                                        <table width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <asp:TextBox ID="txtfromdate" Width="150" runat="server" CssClass="lj_inp">
                                                    </asp:TextBox>
                                                ...
                                                <td>
                                                <asp:TextBox ID="txttodate" Width="150" runat="server" CssClass="lj_inp">
                                                    </asp:TextBox>
                                           ...
                                           <%-- <tr>
                                            ...
                                            <tr>
                                                ...
                                                <tr id="source3" runat="server" visible="true">
                                                    <td>
                                                        Page Size
                                                    </td>
                                                    <td>
