<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Flight/MasterPage.master" AutoEventWireup="true" CodeFile="GuestReports.aspx.cs" Inherits="Users_Flight_GuestReports" %>
                                    ...
                                    <td align="center" width="600">
                                        <table width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <asp:TextBox ID="txtfromdate" Width="150" runat="server">
                                                    </asp:TextBox>
                            ...
                            <asp:GridView ID="GvFlightsReports" Width="100%" runat="server" AutoGenerateColumns="False"
                                ...
                                <columns>
                                    <asp:TemplateField HeaderText="Booking Id" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblBookingId" runat="server" Text='<%# Eval("Dom_Booking_Id") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Travel Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="DepartureAirportName"
                                        ...
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                         <asp:Label ID="lblDepartureAirportName" runat="server"  Text='<%# Eval("airlineName") %>'></asp:Label> 
                                    ...
                                    <asp:TemplateField HeaderText="Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="CustomerDetails"
                                        ...
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblCustomerDetails" runat="server" Width="130px" Text='<%# Eval("Customer_Details") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Refund Amount" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="RefundAmount"
                                    ...
                                    <asp:TemplateField HeaderText="Cancel Charges" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblBookingTime" runat="server" Text='<%# Eval("CreatedDate") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
