<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Flight/MasterPage.master" AutoEventWireup="true" CodeFile="frmPrint.aspx.cs" Inherits="Users_Flight_frmPrint" %>
                        ...
                        <tr>
                            <td valign="top" align="center">
                                <asp:Panel ID="Panel1" Width="501" runat="server" DefaultButton="btnSignIn">
                                    <table width="501" cellspacing="0" cellpadding="0" align="center" >
                                                ...
                                                <table width="400" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="60%">
                                                            <asp:Button ID="btnSignIn" runat="server" Text="Go" CssClass="buttonBook"
                                                                ValidationGroup="signin" OnClick="btnSignIn_Click" />
                                                                     <asp:Button ID="btnSignInInt" runat="server" Text="Go" CssClass="buttonBook" Visible="false"   
