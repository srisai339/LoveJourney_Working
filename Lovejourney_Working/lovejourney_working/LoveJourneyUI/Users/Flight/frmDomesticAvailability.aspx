<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Flight/MasterPage.master" AutoEventWireup="true" CodeFile="frmDomesticAvailability.aspx.cs" Inherits="Users_Flight_frmDomesticAvailability" %>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         ...
         function gorint() {
             ...
             var SelectedValue = DropdownList.value;
             var SelectedText = DropdownList.options[DropdownList.selectedIndex].text;
             document.getElementById('Text19').value = SelectedText;
         }
         function gor1int() {
             var DropdownList = document.getElementById('<%=ddlDestinationsSearch.ClientID %>');
             var SelectedIndex = DropdownList.selectedIndex;
             var SelectedValue = DropdownList.value;
             var SelectedText = DropdownList.options[DropdownList.selectedIndex].text;
             document.getElementById('Text20').value = SelectedText;
         }
         function gor2int() {
             var SelectedText = document.getElementById('<%=txtdatesearch.ClientID %>');
             ...
             var strAr = SelectedText.value.split("-");
             var sel = strAr[2] + "-" + strAr[1] + "-" + strAr[0];
             document.getElementById('Text21').value = sel;
         }
         ...
         function gor3int() {
             ...
             var SelectedValue = DropdownList.value;
             var SelectedText = DropdownList.options[DropdownList.selectedIndex].text;
             document.getElementById('Text22').value = SelectedText;
         }
         function gor4int() {
             var DropdownList = document.getElementById('<%=ddlSourcesSearch.ClientID %>');
             var SelectedIndex = DropdownList.selectedIndex;
             var SelectedValue = DropdownList.value;
             var SelectedText = DropdownList.options[DropdownList.selectedIndex].text;
             document.getElementById('Text23').value = SelectedText;
         }
         function gor5int() {
             ...
             var strAr = SelectedText.value.split("-");
             var sel = strAr[2] + "-" + strAr[1] + "-" + strAr[0];
             document.getElementById('Text24').value = sel;
         }
        ...
        function startsearch() {
            ...
            if (rbtnOneWay.checked) {
                ...
                if (Date1 > Date2) {
                   ...
                   // document.getElementById('<%=mp3.ClientID %>').show();

                    //document.getElementById('<%=lblerror.ClientID %>').value='Return date can not before the Depart date';
                    return false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                                        ...
                                                        <tr>
                                                                                                            ...
                                                                                                            <td valign="top" height="28" align="left">
                                                                                                                ...
                                                                                                                <span class="lj_hd">Infant</span><span class="lj_hd">(&lt;2yrs)</span>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td align="left" height="25" style="padding-left:30px;">
                                                                                                                                                <table cellpadding="0" cellspacing="0" width="300">
                                                                                                                                                    <tr>
                                                                                                                                                        <td>
                                                                                                                                                            <asp:DropDownList ID="ddlAdult" runat="server" CssClass="lj_inp" TabIndex="7" 
                                                                                                                                                                width="50px">
                                                                                                                    ...
                                                                                                                    ValidationGroup="Search" />--%>
                                                                                                                                                ...
                                                                                                                                                </span><span ID="mainDiv5" class="loadingBackground" style="display: none">
                                                                                                                                                </span><span ID="contentDiv5" class="modalContainer" style="display: none">
                                                                                                                                                <div class="registerhead">
                                                                                                                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" 
                                                                                                                                                        style="background-color:White" width="600">
                                                                                                                                                        <tr>
                                                            ...
                                                            <%--<td align="left" width="100%">
                                                                <table width="350" align="center" runat="server" border="0" cellspacing="0" id="tbl_domesticFlights"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                         <td height="39" align="center" colspan="3" valign="top">
                                        <h3 style="color: #336699; font-size: 21px; margin-left: 32px; margin-top: 10px;
                                            margin-bottom: 10px;">
                                            <span style="color: #cc0000;">Domestic Flights </span>Booking</h3>
                                    </td>
                                                                                                    ...
                                                                                                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                                                                                ...
                                                                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                    <tr>
                                                                                                                        <td width="155" valign="middle" align="center" class="lj_one">
                                                                                                                            <asp:RadioButton ID="rbtnOneWay" Text="One Way" runat="server" Checked="true" AutoPostBack="True" TabIndex="0"
                                                                                                                                GroupName="ONE" OnCheckedChanged="rbtnOneWay_CheckedChanged" Font-Names="Arial" />
                                                                                                                        </td>
                                                                                                                        <td valign="middle" align="left" class="lj_one">
                                                                                                                            <asp:RadioButton ID="rbtnRoundTrip" Text="Round Trip" runat="server" AutoPostBack="True" TabIndex="1"
                                                                                                                                GroupName="ONE" OnCheckedChanged="rbtnRoundTrip_CheckedChanged" Font-Names="Arial" />
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td valign="top" height="28" align="left">
                                                                                                                            <asp:DropDownList ID="ddlSources" ValidationGroup="Search" runat="server" Width="150px" CssClass="lj_inp" TabIndex="2">
                                                                                                                                <asp:ListItem Selected="True" Value="BOM">MUMBAI</asp:ListItem>
                                                                                                                                <asp:ListItem Value="DEL">DELHI</asp:ListItem>
                                                                                                                                <asp:ListItem Value="BLR">BANGALORE</asp:ListItem>
                                                                                                                                <asp:ListItem Value="MAA">CHENNAI</asp:ListItem>
                                                                                                            ...
                                                                                                            <td valign="top" height="28" align="left">
                                                                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td valign="top" align="left">
                                                                                                                            <asp:DropDownList ID="ddlDestinations" runat="server" ValidationGroup="Search" CssClass="lj_inp" TabIndex="3"
                                                                                                            ...
                                                                                                            <td valign="top" height="28" align="left">
                                                                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td valign="top" align="left">
                                                                                                                            <asp:TextBox ID="txtFromDate" ValidationGroup="Search" runat="server" onkeyup="return tabE(this,event)" TabIndex="4"
                                                                                                            ...
                                                                                                            <td valign="top" height="28" align="left">
                                                                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td valign="top" align="left">
                                                                                                                            <asp:TextBox ID="txtReturnDate" runat="server" Enabled="False" Visible="true" ValidationGroup="Search" TabIndex="5"
                                                                                                                               onkeyup="return tabE1(this,event)" onPaste="javascript: return false;" OnClick="showDate1();"  CssClass="datepicker1"
                                                                                                                                 />
                                                                                                        ...
                                                                                                        <tr>
                                                                                                          <td  style="padding-left:30px;" align="left" height="25">
                                                                                                               <table width="300" cellspacing="0" cellpadding="0">
                                                                                                                  <tr>
                                                                                                                    <td>
                                                                                                                       <asp:DropDownList ID="ddlAdult"  runat="server" width="50px" CssClass="lj_inp" TabIndex="6">
                                                                                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                                                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                                                                                                    <asp:ListItem Value="3">03</asp:ListItem>
                                                                                                                    <asp:ListItem Value="4">04</asp:ListItem>
                                                                                                                ...
                                                                                                                <asp:DropDownList ID="ddlChild" class="ft02" runat="server" width="50px" CssClass="lj_inp" TabIndex="7">
                                                                                                                    <asp:ListItem Value="0">00</asp:ListItem>
                                                                                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                                                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                                                                                                    <asp:ListItem Value="3">03</asp:ListItem>
                                                                                                                ...
                                                                                                                <asp:DropDownList ID="ddlInfant" class="ft02" runat="server" width="50px" CssClass="lj_inp" TabIndex="8">
                                                                                                                    <asp:ListItem Value="0">00</asp:ListItem>
                                                                                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                                                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                                                                                                    <asp:ListItem Value="3">03</asp:ListItem>
                                                                                                          ...
                                                                                                          <tr>
                                                                                                            <td class="lj_hd" colspan="4" align="left" height="30px" style="padding-left:30px;">
                                                                                                                Cabin:
                                                                                                                <asp:DropDownList ID="ddlCabin_type" class="ft02" runat="server" CssClass="lj_inp" TabIndex="9" Width="180">
                                                                                                                    <asp:ListItem Selected="True" Value="E">Economy Lowest Fare</asp:ListItem>
                                                                                                                    <asp:ListItem Value="ER">Economy Refundable Fare</asp:ListItem>
                                                                                                                    <asp:ListItem Value="B">Business / First Class</asp:ListItem>
                                                                                                                </asp:DropDownList>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td valign="top" align="right">
                                                                                                                <asp:ImageButton ID="ibtnSearch" runat="server" CssClass="check-availability-btn" TabIndex="10"
                                                                                                                    ImageUrl="~/images/check-availability-btn.jpg" OnClick="ibtnSearch_Click"  OnClientClick="return startsearch();" 
                                                                                                                    ValidationGroup="Search" />
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="3" align="center" valign="top">
                                                                                                                                    <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20">
                                                                                                                                                <input id="Text1" type="text"  class="progress" disabled="disabled" style="background-color:White; text-align:right; border:0;"/>
                                                                                                                                                &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                                <input id="Text2" type="text" style="border: 0; background-color:White; text-align:left"  class="progress" disabled="disabled"/>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20">
                                                                                                                                                <input id="Text3" type="text" style="border: 0; background-color:White; text-align:center;" class="progress" disabled="disabled"  />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                </td>
                                   ...
                                   <div id="dvModifySearch" visible="false" runat="server"  style="margin-left:15px;width:950px;">
                                     <h3>Modify Search</h3>
                                                    ...
                                                    <table width="800" cellpadding="0" cellspacing="0" border="0" align="center">
                                                      <tr>
                                                        ...
                                                        <%--  <td class="lj_hd"><asp:RadioButton ID="rbreturnsearch" Text="Round Trip" runat="server" AutoPostBack="True" Font-Size="Medium"
                                                          ...
                                                          <%--<asp:DropDownList ID="ddlSourcesSearch" runat="server" CssClass="lj_inp" 
                                                          ...
                                                          <td width="150">
                                                               ...
                                                               <%--<asp:DropDownList ID="ddlDestinationsSearch" runat="server" CssClass="lj_inp" 
                                                          ...
                                                          <%-- <asp:TextBox ID="txtdatesearch" runat="server" CssClass="datepicker" 
                                                                   ...
                                                                   onPaste="javascript: return false;" ValidationGroup="Search" Width="80px" />
                                                          ...
                                                          <td width="150">
                                                           <asp:DropDownList ID="ddladultsintsearch" width="50" runat="server" CssClass="lj_inp">
                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                                    <asp:ListItem Value="3">03</asp:ListItem>
                                                    <asp:ListItem Value="4">04</asp:ListItem>
                                                    ...
                                                    <asp:ListItem Value="9">09</asp:ListItem>
                                                          ...
                                                          <td width="150">
                                                           <img src="arzoo_search_files/blk.gif" width="40" height="1">
                                                <asp:DropDownList ID="ddlchildintsearch" class="ft02" runat="server" CssClass="lj_inp" Width="50">
                                                    <asp:ListItem Value="0">00</asp:ListItem>
                                                    <asp:ListItem Value="1">01</asp:ListItem>
                                                    <asp:ListItem Value="2">02</asp:ListItem>
                                                    <asp:ListItem Value="3">03</asp:ListItem>
                                                ...
                                                <asp:DropDownList ID="ddlinfantsintsearch" runat="server" CssClass="lj_inp" Width="50">
                                                    ...
                                                    <asp:ListItem Value="8">08</asp:ListItem>
                                                          ...
                                                          <td width="150">
                                                          <asp:DropDownList ID="ddlIntCabinTypesearch" Width="180" class="ft02" runat="server" CssClass="lj_inp">
                                                    <asp:ListItem Selected="True" Value="E">Economy Lowest Fare</asp:ListItem>
                                                    <asp:ListItem Value="ER">Economy Refundable Fare</asp:ListItem>
                                                    <asp:ListItem Value="B">Business / First Class</asp:ListItem>
                                                </asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" align="center" valign="top">
                                                                    <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" height="20">
                                                                                <input id="Text4" type="text" disabled="disabled" class="progress"  style="background-color:White; text-align:right; border:0;"/>
                                                                                &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                <input id="Text5" type="text" style="border: 0;background-color:White; text-align:left;" disabled="disabled" class="progress"  />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center" height="20">
  ...
  <tr>
    ...
    <asp:RadioButton ID="rbonesearch" Text="One Way" runat="server" Checked="true" AutoPostBack="True" 
                                                                GroupName="ONE" OnCheckedChanged="rbonesearch_CheckedChanged"  /></td>
  ...
  <tr>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="3" align="center" valign="top">
                                                                                                                                    <table width="582" border="0" cellspacing="0" cellpadding="0">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20" class="lj_hd">
                                                                                                                                                <input id="Text19" type="text" style="text-align: right; border:0; background-color:white;"    class="progress" />
                                                                                                                                              
                                                                                                                                                &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                                <input id="Text20" type="text" style="border: 0; background-color:White"  disabled="disabled" class="progress" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20" class="lj_hd">
                                                                                                                                                <input id="Text21" type="text" style="border: 0; text-align: center; background-color:White" disabled="disabled" class="progress" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr><td height="20px">&nbsp;</td></tr>
                                                                                                                                         ...
                                                                                                                                         <tr>
                                                                                                                                            <td align="center" height="20" class="lj_hd">
                                                                                                                                                <input id="Text22" type="text" style="text-align: right; border:0; background-color:white;"   readonly="readonly" class="progress" />
                                                                                                                                                &nbsp;&nbsp;To&nbsp;&nbsp;
                                                                                                                                                <input id="Text23" type="text" style="border: 0; background-color:White"  disabled="disabled" class="progress" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" height="20" class="lj_hd">
                                                                                                                                                <input id="Text24" type="text" style="border: 0; text-align: center; background-color:White" disabled="disabled" class="progress" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
   ...
   <tr>
    ...
    <td width="3"><img src="../../images/lb2.png" width="3" height="29"  /></td>
                                                  ...
                                                  <tr><td align="center" width="100%" colspan="3" class="lj_ms_bdr"><table width="100%">
                                                    <tr>
                                            ...
                                            <td align="left" valign="top" runat="server" id="Oneway">
                                                <asp:GridView ID="gdvFlights" Width="100%" runat="server" AutoGenerateColumns="false" AllowSorting="true" GridLines="Horizontal"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Fare" SortExpression="Fare" >
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblFare" runat="server" Text='<%# Eval("Fare") %>'></asp:Label><%--<%# Eval("ActualBaseFare") %>--%>
                                                                <br />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:Panel ID="pnlOnwardFareDetails1" runat="server" Style="display: none; background-color: White;
                                                                                        ...
                                                                                        <td>
                                                                                            Rs.
                                                                                            <asp:Label ID="lblonwardTchargetbl" runat="server"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                                        <tr>
                                                                                                            <td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:5px;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                         ...
                                         <td align="left" width="15%" style="padding-left:15px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Enter Postal Code" ValidationGroup="SubmitBook" Display="None"
                                      ...
                                      <tr id="tronbehalf" runat="server" >
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="rfvagentname" runat="server" ControlToValidate="txtagentname" ErrorMessage="Please enter Username" Display="None"  ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                                                      <ajax:AutoCompleteExtender id="Autocompleteextender1" runat="server" targetcontrolid="txtagentname"
                                                        ...
                                                        servicepath=""></ajax:AutoCompleteExtender>
                                                                                    <ajax:ValidatorCalloutExtender ID="vceagentname" runat="server" TargetControlID="rfvagentname"  CloseImageUrl="~/images/Closing.png" WarningIconImageUrl="~/images/warning.png"></ajax:ValidatorCalloutExtender>
                                    ...
                                    <tr>
                                        <td style="padding-left:5px">
                                            ...
                                            <asp:Button ID="btnRoundTripSubmit" runat="server" CssClass="buttonBook" ValidationGroup="SubmitBook" Text="Submit" OnClick="btnRoundTripSubmit_Click"  />
                                             <asp:Button ID="btnBack" runat="server" CssClass="buttonBook" Text="Back" CauseValidation="false"  onclick="btnBack_Click"  />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <asp:GridView Width="100%" ID="gdvPassengerDetails" runat="server" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Age">
                                                  ...
                                                  <%--   <asp:TemplateField HeaderText="Airline PNR Number">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAirlinePNR" runat="server" Text='<%#Eval("AirlinePNR") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="GDF PNR Number">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblGDFPNRNo" runat="server" Text='<%#Eval("GDFPNRNo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="EticketNo">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEticketNo" runat="server" Text='<%#Eval("eticketNo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>
                                            </Columns>
                                        </asp:GridView>
