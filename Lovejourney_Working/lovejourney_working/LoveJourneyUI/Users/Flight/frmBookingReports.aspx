<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Flight/MasterPage.master" AutoEventWireup="true" CodeFile="frmBookingReports.aspx.cs" Inherits="Users_Flight_frmBookingReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlBookingreports" runat="server">
                ...
                <table width="100%">
                                           ...
                                           <%--   <tr>
                                                ...
                                                <tr>
                                                    <td colspan="5" align="center">
                                                        ...
                                                        <asp:Button ID="btnExport" runat="server" OnClick="btnExport_Click" Text="Export To Excel" Visible="false"
                    ...
                    <tr id="trgv" runat="server">
                        <td>
                                ...
                                OnSorting="GvFlightsReports_Sorting" OnPageIndexChanging="GvFlightsReports_PageIndexChanging"
                                OnRowCommand="GvFlightsReports_RowCommand" PageSize="100">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Travel Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                        SortExpression="DepartureAirportName" HeaderStyle-ForeColor="White" HeaderStyle-Width="90px"
                                    ...
                                    <asp:TemplateField HeaderText="Journey Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                        SortExpression="DepartureDateTime" HeaderStyle-ForeColor="White" HeaderStyle-Width="70px"
                                    ...
                                    <asp:TemplateField HeaderText="Discount" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                      ...
                                      <asp:TemplateField HeaderText="LJ Fare (Rs)" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblMBFare" runat="server" ForeColor="Red"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="TCharge" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblcharge" runat="server" ForeColor="Red"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Refund Amount" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblRefundAmount1" Width="50px" runat="server" ForeColor="Red"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cancel Charges" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        <FooterTemplate>
                                            <asp:Label ID="lblCancellationCharges1" Width="50px" runat="server" ForeColor="Red"></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Booking Date & Time" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        SortExpression="AgentName" HeaderStyle-ForeColor="White" HeaderStyle-Width="70px"
                                        ControlStyle-Width="70px">
                                        <HeaderStyle HorizontalAlign="Center" ForeColor="White"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                        <ItemTemplate>
                    ...
                    <tr>
                        <td width="100%" align="center">
                            <asp:Panel ID="pnlmail" Width="900" runat="server" Visible="false" BackColor="White">
                                       ...
                                       <%-- <tr>
                                                ...
                                                <table width="900" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td align="left" width="300" height="96" valign="top">
                                                            <img src="../../Newimages/New_Logo.png" width="250" height="88" border="0"
                                                                title="Love Journey" />&nbsp;&nbsp;
                                                        </td>
                                                        <td align="right">
                                        ...
                                        <tr>
                                            <td height="5" align="left">
                                                <table width="100%">
                                                <tr>
                                                <td height="5" align="left" width="40%">
                                                <table  width="90%">
