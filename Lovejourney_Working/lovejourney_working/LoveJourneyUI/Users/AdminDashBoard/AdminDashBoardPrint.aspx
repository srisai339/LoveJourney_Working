<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="AdminDashBoardPrint.aspx.cs" Inherits="AdminDashBoard_AdminDashBoardPrint" %>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" height="20" align="center">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMBRefNo"
                                                                Display="None" ErrorMessage="Please Enter Ref No." ValidationGroup="signin" />
                                                            <ajax:ValidatorCalloutExtender ID="vceBRefNo" runat="server" TargetControlID="RequiredFieldValidator1"></ajax:ValidatorCalloutExtender>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" align="center">
                                                            <table width="400" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #0062af">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="left" width="60%">
                                                                        <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="buttonBook"
                                                                            ValidationGroup="signin" OnClick="btnSignIn_Click" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <table width="50%" style="border:1px solid #0062af" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="60%">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtRefNo1"
                                                                Display="None" ErrorMessage="Please Enter ref no." ValidationGroup="submit"></asp:RequiredFieldValidator>
                                                            <ajax:ValidatorCalloutExtender ID="vceBookingRefNo" runat="server" TargetControlID="RequiredFieldValidator2"></ajax:ValidatorCalloutExtender>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" width="40%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="60%">
                                                            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit"
                                                                ValidationGroup="submit" CssClass="buttonBook" />
                                                        </td>
                                                    </tr>
                                                      <tr>
                                                        <td width="40%" align="right">
