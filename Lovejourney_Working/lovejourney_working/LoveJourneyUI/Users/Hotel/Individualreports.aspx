<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Hotel/MasterPage.master" AutoEventWireup="true" CodeFile="Individualreports.aspx.cs" Inherits="Users_Hotel_Individualreports" %>
...
<table width="100%" style="table-layout: fixed; background-color: White;">
        <tr>
                ...
                <asp:Panel ID="pnlSearch" runat="server">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="35%" align="left">
                                ...
                                <ajax:CalendarExtender ID="CalendarExtender1" runat="server" FirstDayOfWeek="Sunday"
                                    Format="dd-MM-yyyy" TargetControlID="txtfromdate" PopupButtonID="ImageButton2">
                                </ajax:CalendarExtender>
                            </td>
                            <td width="18%" align="left">
                                <%--  CheckOut Date--%>To Date
                            </td>
                            <td width="32%" align="left">
                                ...
                                <ajax:CalendarExtender ID="CalendarExtender2" runat="server" FirstDayOfWeek="Sunday"
                                    Format="dd-MM-yyyy" TargetControlID="txttodate" PopupButtonID="ImageButton1">
                                </ajax:CalendarExtender>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr id="source2" runat="server" visible="false">
                            ...
                            <td width="35%" align="left">
                                <select name="strcity" id="ddlCity" style="width: 120px;" runat="server" visible="false">
        ...
        <tr>
            <td width="100%">
                <asp:Panel ID="pnlSearchResults" runat="server" ScrollBars="Horizontal">
                                ...
                                <asp:GridView ID="gvBookings" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Total Fare" SortExpression="HotelTotalFare">
                                            <ItemTemplate>
                                                <asp:Label ID="lblHotelTotalFare" Text='<%# Eval("HotelTotalFare") %>' runat="server" />
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblHotelTotalFare1" ForeColor="Red" runat="server" />
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Total Fare" SortExpression="HotelTotalFare" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblActualFare" Text='<%# Eval("HotelTotalFare") %>' runat="server" />
                                            </ItemTemplate>
                                            <FooterTemplate>
