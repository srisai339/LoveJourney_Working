<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Hotel/MasterPage.master" AutoEventWireup="true" CodeFile="UserReports.aspx.cs" Inherits="Users_Hotel_UserReports" %>
 ...
 <table width="100%">
    ...
    <table width="100%" style="table-layout: fixed;">
        ...
        <td width="100%" align="center" class="heading">
                <asp:Label ID="Label1" runat="server" Text="User Hotel Bookings" Font-Size="13px"></asp:Label>
            </td>
           <%-- <td width="100%" valign="top">
               
             <h3 style="color: #336699; font-size: 21px; margin-left: 32px; margin-top: 10px;
                                margin-bottom: 10px;">
                                <span style="color: #cc0000;">Agent Hotel </span> Bookings</h3>
                      ...
                      <%--          <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/calendar.jpg" />
                        ...
                        <tr>
                         ...
                         <td width="15%" align="left">
                            ...
                            <td width="32%" align="left">
                                <asp:TextBox ID="txtreferenceno" runat="server" CssClass="Textbox" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="18%" align="left">
                                ...
                                <asp:Button ID="btnReset" Text="Reset" runat="server" CssClass="buttonBook"
                                    OnClick="btnReset_Click" Style="cursor: pointer;" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <td width="32%" align="left">
                                <asp:Button ID="btnExport" runat="server" OnClick="btnExport_Click" Text="Export To Excel" CssClass="buttonBook"
                        ...
                        <tr>
                            <td width="100%">
                                <asp:GridView ID="gvBookings" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                    Width="90%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Cancel Charge" SortExpression="CancellationCharges" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="btnView" Text="View" runat="server" CssClass="buttonBook"
                                                    CommandName="View" CommandArgument='<%# Eval("ReferenceNo") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
