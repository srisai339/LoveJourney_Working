...
<body onload="Load()">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="54" align="left">
                                                                ...
                                                                <div id="dropmenu2_s" class="dropmenudiv_e">
                                                                    ...
                                                                    </a><a href="../Bus/ChangePassword.aspx" id="lichangepassword" runat="server">Change
                                                                        Password </a><a href="CashCoupon.aspx" id="Cashcoupon" runat="server">Cash Coupon</a>
                                                                    <a href="PromoCode.aspx" rel="dropmenu2_p" id="lipromocode" runat="server">Promo Code</a>
                                                                    <a href="../Bus/Users.aspx" id="licse" runat="server">CSE</a> <a href="../Bus/ViewFeedbacks.aspx"
                                    ...
                                    <td bgcolor="#4f91cd" height="30">
                                        <div id="chromemenu" class="chromestyle">
                                            <ul>
                                                ...
                                                <li id="lisubmenuprint" runat="server"><a href="PrintTicket.aspx">Print Ticket</a></li>
                                                <li id="lisubmenucancel" runat="server"><a href="CancelTicket.aspx">Cancel Ticket</a></li>
                                                <li id="lisubmenureports" runat="server"><a href="Bookings.aspx">Bookings</a></li>
                                                <li id="lisubmenuAgentReports" runat="server"><a href="AgentBookings.aspx">Agent Bookings</a></li>
                                                <li id="li1" runat="server" visible="false"><a href="UserReports.aspx" rel="dropmenu3">
                                                    Bookings</a></li>
                                            </ul>
                                        </div>
                                    </td>
                            ...
                            <asp:Panel ID="pnlMain" runat="server">
                                <table width="964" border="0">
                                    <tr>
                                                                    ...
                                                                    <table width="360" align="right" cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td height="28" align="left">
                                                                                <select name="strcity" id="ddlCity" style="width: 150px;" class="lj_inp" onchange="showDate();"
                                                                                    tabindex="1">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="28" align="left">
                                                                                <input size="15" type="text" name="check_Inhotel" onclick="showDate();" onfocus="this.blur();"
                                                                                    tabindex="2" class="datepicker" id="check_Inhotel" value="" onkeyup="return tabE(this,event)" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="28" align="left" class="lj_hd12">
                                                                            ...
                                                                            <td height="28" align="left">
                                                                                <input type="text" size="15" name="check_Outhotel" onfocus="this.blur();" onclick="showDate1();"
                                                                                    onkeyup="return tabE1(this,event)" class="datepicker1" id="check_Outhotel" value=""
                                                                                    tabindex="3" />
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td height="28" align="left">
                                                                                <select size="1" name="no_ofrooms" style="width: 150px;" onchange="javascript:changeRows();"
                                                                                    class="lj_inp" tabindex="5" onkeyup="return tabE3(this,event)">
                                        ...
                                        <td width="527" height="376" align="center" valign="middle">
                                            <%-- <img src="../../images/hotel_banner.png" />--%>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td>
                <asp:ModalPopupExtender ID="mp3" runat="server" PopupControlID="Panel1" TargetControlID="FeedBack"
                    X="350" Y="250" BackgroundCssClass="loadingBackground" OkControlID="btnMsg1">
                </asp:ModalPopupExtender>
                <asp:Panel ID="Panel1" runat="server" Style="display: none; color: Black; border: 5px solid #3e6cc4;
                                ...
                                <table width="300" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" height="28">
                                            ...
                                            <asp:ValidatorCalloutExtender ID="vceName" runat="server" TargetControlID="rfvname"></asp:ValidatorCalloutExtender>
                                            <asp:FilteredTextBoxExtender ID="ftbename" runat="server" TargetControlID="txtName"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" height="28">
                                            ...
                                            <asp:ValidatorCalloutExtender ID="vceEmail" runat="server" TargetControlID="RequiredFieldValidator1"></asp:ValidatorCalloutExtender>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail"
                                                Display="None" ErrorMessage="Invalid Email Id" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                                                ValidationGroup="submit" />
                                            <asp:ValidatorCalloutExtender ID="vceEmail1" runat="server" TargetControlID="RegularExpressionValidator1"></asp:ValidatorCalloutExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="lj_hd12" height="28">
                                        ...
                                        <td align="left" height="28">
                                            ...
                                            <asp:ValidatorCalloutExtender ID="vcePhone" runat="server" TargetControlID="RequiredFieldValidator2"></asp:ValidatorCalloutExtender>
