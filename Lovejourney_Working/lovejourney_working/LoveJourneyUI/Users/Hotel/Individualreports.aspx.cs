...
public partial class Users_Hotel_Individualreports : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (Session["UserID"] != null)
            {
                ...
                else
                {
                    ...
                    obj.CheckIn = Convert.ToDateTime(dt);
                }
                ...
                else
                {
                    ...
                    //DateTime Todate = Convert.ToDateTime(txtfromdate.Text);
                    //string formattedToDate = Todate.ToString("yyyy-MM-dd");
                    obj.CheckOut = Convert.ToDateTime(dt1);
                }
                ...
                DataSet ObjDataset = (DataSet)obj.SearchAgentBookedTickets();
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            txtDOJ.Text = txtDateOfIssue.Text = txtName.Text = txtEmailID.Text = txtManabusRefNo.Text = txtContact.Text = ""; txtfromdate.Text = ""; txttodate.Text = "";
            //  BindBookedTickets();
        }
        catch (Exception ex)
        {
    ...
    protected void gvBookings_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            {
                HotelTotalFare += (DataBinder.Eval(e.Row.DataItem, "HotelTotalFare").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "HotelTotalFare"));
                actualFareTotal += (DataBinder.Eval(e.Row.DataItem, "ActualFare").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "ActualFare"));
                commisionFare += (DataBinder.Eval(e.Row.DataItem, "CommisionFare").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "CommisionFare"));
                mbFare += (DataBinder.Eval(e.Row.DataItem, "MBFare").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "MBFare"));
                cancellationCharges += (DataBinder.Eval(e.Row.DataItem, "CancellationCharges").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "CancellationCharges"));
                refundAmount += (DataBinder.Eval(e.Row.DataItem, "RefundAmount").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "RefundAmount"));
                markUp += (DataBinder.Eval(e.Row.DataItem, "Comment").ToString() == "") ? 0.0 : Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "Comment"));
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                lbllblActualFareTotal.Text = actualFareTotal.ToString();
                ...
                Label lblHotelTotalFare = (Label)e.Row.FindControl("lblHotelTotalFare1");
                lblHotelTotalFare.Text = HotelTotalFare.ToString("####0.00");
            }
        }
        catch (Exception ex)
        {
