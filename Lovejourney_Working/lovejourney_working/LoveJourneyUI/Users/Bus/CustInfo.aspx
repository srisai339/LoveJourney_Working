                                            ...
                                            <td width="70%" valign="top" align="left">
                                                <table width="100%">
                                                    <tr>
                                                        <td width="100%" colspan="3">
                                                            ...
                                                            <asp:Panel ID="pnlPassengersOnward" runat="server" Width="100%">
                                                                <table width="100%">
                                                                    <asp:Repeater ID="rptPassengersonward" runat="server" 
                                                                        onitemdatabound="rptPassengersonward_ItemDataBound">
                                                                        <HeaderTemplate>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td width="10%" align="left">
                                                                                    <asp:DropDownList ID="ddlGender" runat="server" Enabled="true" CssClass="sel" Width="70px" ValidationGroup="ContinueToPassengerList">
                                                            ...
                                                            <asp:Panel ID="pnlPassengersReturn" runat="server" Width="100%">
                                                                <table width="100%">
                                                                    <asp:Repeater ID="rptrPsgrDetailsReturn" runat="server" 
                                                                        onitemdatabound="rptrPsgrDetailsReturn_ItemDataBound">
                                                                        <HeaderTemplate>
                                                                            <tr class="boxbluerowheadr">
                                                                                <td width="20%" align="left">
                                                                                    Seat
                                                            ...
                                                            <asp:Panel ID="pnlPassengersReturn0" runat="server" Width="100%">
                                                                <table width="100%">
                                                                    <asp:Repeater ID="rptrPsgrDetailsReturn0" runat="server" 
                                                                        onitemdatabound="rptrPsgrDetailsReturn0_ItemDataBound">
                                                                        <HeaderTemplate>
                                                                            <tr class="boxbluerowheadr">
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td width="70%" align="left">
                                                            <asp:TextBox ID="txtAddress" MaxLength="200" runat="server" CssClass="textfield_2"
                                                                Width="225" ValidationGroup="ContinueToPassengerList"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="70%" align="left">
                                                            <asp:CheckBox ID="cbxAgree" Enabled="false" runat="server" Text=" I agree to all the"
                                                                Checked="True" /><a href="Terms_Conditions.aspx" target="_blank">Terms &amp; Conditions</a>
                                                        </td>
                                                        <td width="10%">
                                                            &nbsp;
                                                        </td>
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td width="80%" align="left">
                                                                        <asp:RadioButtonList ID="rbtnlstpaytype" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                                                                            OnSelectedIndexChanged="rbtnlstpaytype_SelectedIndexChanged">
                                                                            <asp:ListItem Text="Payment Gateway" Value="0" Selected="True" />
                                                                            <asp:ListItem Text="Home Delivery" Value="3" />
                                                                        </asp:RadioButtonList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="left" width="100%" colspan="3" style="padding-left: 50px;">
                                                            <asp:CheckBox ID="chkCashpay" Text="Cash Payment" runat="server" AutoPostBack="true"
                                                                OnCheckedChanged="chkCashpay_CheckedChanged" Visible="false" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%">
                                                                    ...
                                                                    <table width="95%" cellpadding="0" cellspacing="0" style="line-height: 25px;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:TextBox ID="txtAddressHD" runat="server" TextMode="MultiLine" Width="200px"
                                                                                    Height="100"></asp:TextBox>
                                                                                <asp:RequiredFieldValidator ID="rfvaddress" runat="server" ErrorMessage="Please Enter Address"
                                                                                    ValidationGroup="ContinueToPassengerList" ControlToValidate="txtAddress" Display="None"></asp:RequiredFieldValidator>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="40%" align="left" valign="top">
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:TextBox ID="txtLandmark" runat="server" MaxLength="50" CssClass="textfield_2"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="40%" align="left" valign="top">
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:DropDownList runat="server" ID="drpdwncity">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:TextBox ID="txtdeliverydate" runat="server" MaxLength="50" CssClass="textfield_2"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="40%" align="left" valign="top">
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:DropDownList runat="server" ID="dropdwnpincode">
                                                                                </asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:DropDownList ID="ddlHour" runat="server" CssClass="Dropdownlist" Width="50px">
                                                                                </asp:DropDownList>
                                                                                &nbsp;&nbsp;
                                                                                <asp:DropDownList ID="ddlMinutes" runat="server" CssClass="Dropdownlist" Width="50px">
                                                                                </asp:DropDownList>
                                                                                &nbsp;&nbsp;
                                                                                <asp:DropDownList ID="ddlAmPm" runat="server" CssClass="Dropdownlist" Width="50px">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" align="left" valign="top">
                                                                                <asp:TextBox ID="txtComments" runat="server" TextMode="MultiLine" Width="200px" Height="100"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" width="40%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="70%">
                                                            ...
                                                            &nbsp;
                                                            <asp:Button ID="btnProceedToPayment" runat="server" CssClass="et_srch"
                                                                OnClick="btnProceedToPayment_Click"  Text="Proceed"
                                                                ValidationGroup="ContinueToPassengerList" />
                                                            <span id="mainDiv" class="loadingBackground" style="display: none"></span><span id="contentDiv"
                                                                ...
                                                                <div class="registerhead">
                                                                    <img alt="img" src="images/loading.gif" width="150" height="150" />
                                                                </div>
                                                            </span>
                                                        </td>
                                                        <td width="10%">
                                                                ...
                                                                <table width="900" align="center">
                                                                    <tr>
                                                                        ...
                                                                        <td width="115" align="right">
                                                                            <span class="actions"><a onclick="printPage('printdiv');" target="_blank" class="et_srch">Print</a></span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                                    ...
                                                                                    <table width="900" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td align="left" width="300" height="96" valign="top">
                                                                                                <img src="http://Lovejourney.in/images/logo.jpg" width="200" height="100" border="0"
                                                                                                    title="" />&nbsp;&nbsp;
                                                                                                <asp:Image ID="imgKesineni" runat="server" Visible="false" />
                                                                                            </td>
