<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master" AutoEventWireup="true"
    CodeFile="AgentRequests.aspx.cs" Inherits="Users_AgentRequests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <table width="100%">
    ...
    <table width="100%">
        <tr>
            <td align="center"  >
            <asp:LinkButton ID="lbtnBack" runat="server" Text="Back" PostBackUrl="~/Users/Bus/Agents.aspx" Visible="false"></asp:LinkButton>
            ...
            <td>
                <div>
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:GridView ID="gvAgentRequests" runat="server" AllowPaging="True" OnPageIndexChanging="gvAgentRequests_PageIndexChanging"
                                    Width="100%" AutoGenerateColumns="false" PageSize="100"
                                    onrowcommand="gvAgentRequests_RowCommand">
                                ...
                                <SelectedRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-Width="30%">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnDelete" runat="server" CommandName="Remove" Text="Delete" CssClass="buttonBook" Visible="false"
                ...
                <div>
                  <table width="100%">
                        <tr>
                            <td>
                                <asp:GridView ID="gvAgentRequestfromemp" runat="server" AllowPaging="True" 
                                    Width="100%" AutoGenerateColumns="false" PageSize="100" 
                                    onrowcommand="gvAgentRequestfromemp_RowCommand" onrowediting="gvAgentRequestfromemp_RowEditing"
                                    >
                                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" Height="30" />
                                <PagerStyle BackColor="White" ForeColor="#000066" HorizontalAlign="Center" />
                                <RowStyle ForeColor="#000066" HorizontalAlign="Center" Height="25" />
                                <SelectedRowStyle BackColor="#669999" Font-Bold="True" ForeColor="White" />
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="UserName" HeaderText="EmployName" />
                                        <asp:BoundField DataField="CreatedDate" HeaderText="CreatedDate" />
                                        <asp:BoundField DataField="Name" HeaderText="Name" />
                                        <asp:BoundField DataField="EmailId" HeaderText="EmailId" />
                                        <asp:BoundField DataField="Organization" HeaderText="Organization" />
                ...
                <div>
                  <table width="100%">
                        <tr>
                            <td>
                                <asp:GridView ID="gvAgentrequestfromemp1" runat="server" AllowPaging="True" 
                                    Width="100%" AutoGenerateColumns="false" PageSize="100" 
                                    onrowcommand="gvAgentRequestfromemp_RowCommand" onrowediting="gvAgentRequestfromemp_RowEditing"
                                    >
                                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" Height="30" />
                    ...
                    <fieldset>
                        ...
                        <table width="100%" align="center">
                           ...
                           <%--         <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlState"
                            ...
                            <tr id="dist" runat="server" visible="true">
                                <td class="labelclass">
                                    &nbsp;
                                </td>
                                <td class="labelclass">
