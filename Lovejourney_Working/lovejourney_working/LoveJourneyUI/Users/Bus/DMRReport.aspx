<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="DMRReport.aspx.cs" Inherits="Users_Bus_DMRReport" %>
    ...
    <table width="100%" id="tblMain" runat="server" style="background-color:White;">
        ...
        <tr>
            <td width="100%" align="center" class="heading">
                <asp:Label ID="Label1" runat="server" Text="DMR Report" Font-Size="13px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                    ...
                                    <Columns>
                                      ...
                                      <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:RadioButton ID="rbtnApproved" runat="server" Text="Yes" GroupName="Status"
                                                        ForeColor="Green" AutoPostBack="true" OnCheckedChanged="rbtnStatus_CheckedChanged"
                                                        ValidationGroup='<%# Eval("ID") %>' />
                                                    <asp:RadioButton ID="rbtnHold" runat="server" Text="No" GroupName="Status" ForeColor="Red"
                                                        AutoPostBack="true" OnCheckedChanged="rbtnStatus_CheckedChanged" ValidationGroup='<%# Eval("ID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                  <asp:Button ID="btnedit" Text="Edit" runat="server" CssClass="buttonBook" CommandName="EDIT"
