            ...
            <td width="100%" align="center" class="heading">
                    Change Password
                            ...
                            <tr>
                                ...
                                <td align="left" >
                                    <asp:TextBox ID="txtCurrentPassword" MaxLength="50" runat="server" 
                                        Width="200px" ValidationGroup="ChangePassword" TextMode="Password"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtConfirmPassword" MaxLength="50" runat="server" Width="200px"
                                        ValidationGroup="ChangePassword" TextMode="Password"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvConfirmPassword" runat="server" Display="None" ValidationGroup="ChangePassword"  ErrorMessage="Please Enter Confirm Password" ControlToValidate="txtConfirmPassword"></asp:RequiredFieldValidator>
                                    <ajax:ValidatorCalloutExtender ID="vceConfirmPassword" runat="server" TargetControlID="rfvConfirmPassword"></ajax:ValidatorCalloutExtender>
                                    ...
                                    <ajax:ValidatorCalloutExtender ID="vceConfirmPassword1" runat="server" TargetControlID="CompareValidator5"></ajax:ValidatorCalloutExtender>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" width="30%">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button ID="btnChangePassword" runat="server" Text="Change Password" OnClick="btnChangePassword_Click" CssClass="buttonBook"
                                        ValidationGroup="ChangePassword" Style="cursor: pointer;" />
                                </td>
...
<%--<table width="100%" cellpadding="0" cellspacing="0" border="0" id="tblmain" runat="server">
    
        <tr>
          <td class="heading" align="center" colspan="3">
            Change Password  
          </td>
        </tr>
        <tr>
           <td id="tdmsg" runat="server" colspan="3">
             <asp:Label ID="lblMainMsg" runat="server"></asp:Label> 
           </td>
        </tr>
        <tr>
