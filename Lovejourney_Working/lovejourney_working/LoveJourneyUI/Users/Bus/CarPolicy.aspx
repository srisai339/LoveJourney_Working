<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master" AutoEventWireup="true" CodeFile="CarPolicy.aspx.cs" Inherits="Users_Bus_CarPolicy" %>
                ...
                <table width="990" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="lj_dbrd_hd" valign="middle" align="center">
                            &nbsp;&nbsp;
                            <asp:Label ID="lblHead" runat="server" Font-Size="16px" Text="Car Policy" ></asp:Label>
                        </td>
                            ...
                            <table>
                                <tr id="trCCode1" runat="server">
                                    <td class="labelboldleft" style="width: 40%" visible="true" align="right">
                                        <asp:Label ID="lblNotices" runat="server" Text="Car Policy :"></asp:Label>
