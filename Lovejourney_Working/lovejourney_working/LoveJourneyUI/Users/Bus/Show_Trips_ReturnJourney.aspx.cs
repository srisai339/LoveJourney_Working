...
public partial class Users_Show_Trips_ReturnJourney : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                BaseClass baseCls = (BaseClass)(HttpContext.Current.Session["Parameters"]);
                travelOperatorSelected = "";

                lblRoute.Text = baseCls.preLoadParams[5].Trim() + "<span style='color:Black;'> <i>to</i> </span>" + baseCls.preLoadParams[4].Trim()
                    + "<span style='color:Black;'> <i>on</i> </span>" + baseCls.preLoadParams[3].Trim();

                //LoadRoutes(this, ''); 
                //ClientScript.RegisterStartupScript(GetType(), "hwa", "alert('hi'); $('#div_routes').html('<img src='images/loadingtext.gif' />'); ", true); 
                //ScriptManager.RegisterStartupScript(this, typeof(Page), "Alert", "<script>alert('hi'); $('#div_routes').html('<img src='images/loadingtext.gif' />'); LoadRoutes(this, ''); </script>", false);
                ...
                else
                {
                    ...
                    //ObjDataset = (DataSet)Common.GetCache("cachedSourceList");

                    //if (ObjDataset == null)
                    //{
                    //    objManabusBAL = new ClsManaBusBAL();
                    //    ObjDataset = objManabusBAL.GetSourcess();
                    //    Common.AddCache("cachedSourceList", ObjDataset, 6);
                    //}
                    //if (ObjDataset != null)
                    //{
                    ...
                    //            //ddlDestinations.DataValueField = "ID";//"AllIds";
                    ...
                    //            System.Web.UI.WebControls.ListItem ltAhmedabad = new System.Web.UI.WebControls.ListItem();
                    //            ltAhmedabad.Value = "Bit-18:Abh-242"; ltAhmedabad.Text = "Ahmedabad";
                    //            ddlSources.Items.Insert(1, ltAhmedabad);


                    //            System.Web.UI.WebControls.ListItem ltBangalore = new System.Web.UI.WebControls.ListItem();
                    //            ltBangalore.Value = "Bit-134:Kes-9:Abh-7:Kal-569"; ltBangalore.Text = "Bangalore";
                    //            ddlSources.Items.Insert(2, ltBangalore);


                    //            System.Web.UI.WebControls.ListItem ltChennai = new System.Web.UI.WebControls.ListItem();
                    //            ltChennai.Value = "Bit-251:Kes-8:Abh-6:Kal-575"; ltChennai.Text = "Chennai";
                    //            ddlSources.Items.Insert(3, ltChennai);


                    //            System.Web.UI.WebControls.ListItem ltCoimbatore = new System.Web.UI.WebControls.ListItem();
                    //            ltCoimbatore.Value = "Bit-287:Kes-92:Kal-562"; ltCoimbatore.Text = "Coimbatore";
                    //            ddlSources.Items.Insert(4, ltCoimbatore);


                    //            System.Web.UI.WebControls.ListItem ltDelhi = new System.Web.UI.WebControls.ListItem();
                    //            ltDelhi.Value = "Bit-315:Abh-344"; ltDelhi.Text = "Delhi";
                    //            ddlSources.Items.Insert(5, ltDelhi);


                    //            System.Web.UI.WebControls.ListItem ltGoa = new System.Web.UI.WebControls.ListItem();
                    //            ltGoa.Value = "Bit-428:Abh-102"; ltGoa.Text = "Goa";
                    //            ddlSources.Items.Insert(6, ltGoa);


                    //            System.Web.UI.WebControls.ListItem ltHyderabad = new System.Web.UI.WebControls.ListItem();
                    //            ltHyderabad.Value = "Bit-506:Kes-3:Abh-3:Kal-1032"; ltHyderabad.Text = "Hyderabad";
                    //            ddlSources.Items.Insert(7, ltHyderabad);


                    //            System.Web.UI.WebControls.ListItem ltMumbai = new System.Web.UI.WebControls.ListItem();
                    //            ltMumbai.Value = "Bit-961:Kes-6:Abh-4"; ltMumbai.Text = "Mumbai";
                    //            ddlSources.Items.Insert(8, ltMumbai);


                    //            System.Web.UI.WebControls.ListItem ltPune = new System.Web.UI.WebControls.ListItem();
                    //            ltPune.Value = "Bit-1198:Kes-5:Abh-51"; ltPune.Text = "Pune";
                    //            ddlSources.Items.Insert(9, ltPune);


                    //            ddlSources.Items.Insert(10, "----------");
                    //        }
                    //    }
                    //}
                    ...
                    //DataTable dtDestinations = (DataTable)Session["sesDTDestinations"];
                    //ddlDestinations.DataSource = dtDestinations;
                    //ddlDestinations.DataTextField = "DestinationName";
                    //ddlDestinations.DataValueField = "Id";//"AllIds";
                    //ddlDestinations.DataBind();
                    //ddlDestinations.Items.Insert(0, "----------");

                    DateTime dt = Convert.ToDateTime(baseCls.preLoadParams[3].ToString());
                    string sss = dt.ToString("dd-MMMM-yyyy");
                    lblJD.Text = sss;

                    ListItem ltSource = new ListItem();
                    ltSource.Value = baseCls.preLoadParams[1].ToString();
                    ltSource.Text = baseCls.preLoadParams[5].ToString();
                    ltSource.Selected = true;
                    ddlSources.Items.Add(ltSource);
                    ddlSources.Enabled = false;

                    //DataTable dtDestinations = (DataTable)Session["sesDTDestinations"];
                    StringBuilder sbTravels = new StringBuilder();
                    //if (dtDestinations.Rows.Count > 0)
                    //{
                    sbTravels.Append("<select id=\"ddldestinationsDiv\" disabled=\"disabled\" name=\"ddldestinationsDiv\" class=\"Dropdownlist\" >");

                    sbTravels.Append("<option value=''>----------</option>");
                    //foreach (DataRow item in dtDestinations.Rows)
                    //{
                    //if (baseCls.preLoadParams[4].ToString() != item["DestinationName"].ToString())
                    //{
                    //    sbTravels.Append("<option value=" + item["ID"].ToString() + ">" + item["DestinationName"].ToString() + "</option>");
                    //}
                    //else
                    {
                        sbTravels.Append("<option selected='selected' value=" + baseCls.preLoadParams[0].ToString() + ">" + baseCls.preLoadParams[4].ToString() + "</option>");
                    }
                    //}
    ...
    protected void btnContinue_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            drTicketDetails["Route"] = baseCls.preLoadParams[5].ToString() + "  To  " + baseCls.preLoadParams[4].ToString() + "";
            drTicketDetails["JourneyDate"] = baseCls.preLoadParams[3].ToString();
            ...
            Session["dtTicketInfoReturn"] = dtTicketInfo;
