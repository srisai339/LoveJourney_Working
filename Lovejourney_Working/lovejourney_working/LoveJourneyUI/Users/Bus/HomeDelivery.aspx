<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bus/MasterPage.master"
    AutoEventWireup="true" CodeFile="HomeDelivery.aspx.cs" Inherits="Users_HomeDelivery"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <asp:MultiView ID="MVHomedelivery" runat="server">
                <asp:View ID="VWHomedeliverySearch" runat="server">
                            ...
                            <table width="100%">
                                    ...
                                    <td width="80%" align="center">
                                        <table width="80%" cellpadding="0" cellspacing="0" style="line-height: 30px;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="35%" align="left" valign="top">
                                                    <asp:DropDownList ID="ddlDatefilter" runat="server" CssClass="Dropdownlist">
                                                        ...
                                                        <asp:ListItem Text="Date Of Issue" />
                                            ...
                                            <tr>
                                                ...
                                                <td width="35%" align="left" valign="top">
                                                    <asp:DropDownList ID="ddlHomeDeliveryStatus" runat="server" CssClass="Dropdownlist">
                                                        <asp:ListItem Text="ALL" />
                                                ...
                                                <td width="35%" align="left" valign="top">
                                                    <asp:Button ID="btnsearch" Text="Seacrh" runat="server" CssClass="buttonBook"
                                ...
                                <tr>
                                    <td width="100%" align="center">
                                        <asp:GridView ID="GvHomeDelivery" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                            Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                                            CellPadding="3" EnableModelValidation="True" EmptyDataText="No office Pickup tickets Records"
                                            OnPageIndexChanging="GvHomeDelivery_PageIndexChanging" OnSorting="GvHomeDelivery_Sorting"
                                            OnRowCommand="GvHomeDelivery_RowCommand" OnRowDataBound="GvHomeDelivery_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Manabus Ref No" SortExpression="OnewayMBRefNo">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Time Elasped" SortExpression="Timeelasped">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTimeelasped" Text='<%#Eval("Timeelasped") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <asp:View ID="vwViewDetails" runat="server">
                                                    ...
                                                    <table width="900" cellspacing="0" cellpadding="0" border="1px solid black;">
                                                                ...
                                                                <table width="900" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td align="left" width="300" height="96" valign="top">
                                                                            <img src="http://lovejourney.in/images/logo.jpg" width="143" height="88" border="0"
                                                                                title="" />&nbsp;&nbsp;
                                                                                            ...
                                                                                            <table width="900" border="0" cellspacing="0" cellpadding="0" class="ticket_bdr">
                                                                                                <tr>
                                                                                                    <td align="left" height="26" valign="top">
                                                                                                        <b class="man_hd">Manabus Reference Number :</b>&nbsp;
                                                                                                                ...
                                                                                                                <td align="center">
                                                                                                                    <table width="580" border="0" cellspacing="0" cellpadding="0">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td align="left">
                                                                                                                                <asp:Label ID="lblAmount" runat="server" Text='<%#Eval("TotalFare") %>' />
                                                                                                                            </td>
                                                                                                                            <td align="left">
                                                                                                                                <b><u>Delivery charges</u></b>
                                                                                                                            </td>
                                                                                                                            <td align="left">
                                                                                                                                <asp:Label ID="lblDeliverycharges" runat="server" Text="40.00" />
                                                                                                                            </td>
                                                                                                                            <td align="left">
                                                                                                                                <b><u>Total</u></b>
                                                                                                                            </td>
                                                                                                                            <td align="left">
                                                                                                                                <asp:Label ID="lblTotal" runat="server" Text='<%#Eval("TotalFare") %>' />
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                </td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" align="left" valign="top">
                                                                <table width="100%" style="background-color: White; line-height: 20px;">
                                                                    <tr>
                                                                        <td width="30%" align="left">
                                                                        ...
                                                                        <td width="70%" align="right">
                                                                            Amount Expected:&nbsp;:&nbsp;<asp:Label ID="lblAmountExpected" runat="server"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="50%" align="left">
                                                                            Name&nbsp;:&nbsp;<asp:Label ID="lblNameCusinfo" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="50%" align="left">
                                                                            Contact No&nbsp;:&nbsp;<asp:Label ID="lblContactNoCusInfo" runat="server"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="50%" align="left">
                                                                            City&nbsp;:&nbsp;<asp:Label ID="lblCityCusInfo" runat="server"></asp:Label>
                                                                        </td>
                                                                        <td width="50%" align="left">
                                                                            Landmark&nbsp;<asp:Label ID="lblLandmarkCusiNfo" runat="server"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="100%" align="left" colspan="2">
                                                                            Address:&nbsp;:&nbsp;<asp:Label ID="lblAddressCusiNfo" runat="server"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                    ...
                    <table width="400" cellpadding="0" cellspacing="0" style="line-height: 30px;">
                        ...
                        <tr>
                            ...
                            <td width="50%" align="left">
                                ...
                                <asp:RequiredFieldValidator ID="rfvMnyCollectedBY" ErrorMessage="*" runat="server"
