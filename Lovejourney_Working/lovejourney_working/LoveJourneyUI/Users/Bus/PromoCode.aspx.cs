...
public partial class Users_PromoCode : System.Web.UI.Page
{
    ...
    protected String GeneratePromocode()
    {
        ...
        return "PC"+stringBuilder.ToString();
    }
    protected bool AddPromoCode()
    {
        try
        {
            ...
            objBAL.promoCode = Convert.ToString(lblCode.Text);
        ...
        next:
            ...
            else
            {
                ...
                if (REs1)
                {
                    ...
                    string script = "alert('Promo code is " + lblCode.Text + "');";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["PromoCodes"] != null)
            {
                ...
                DataRow[] dr = DtCommission.Select("PromoCode like '" + "%" + txtSearch.Text + "%" + "'" + "or " + "UserName like '" + "%" + txtSearch.Text + "%" + "'");
                if (dr.Length > 0)
                {
