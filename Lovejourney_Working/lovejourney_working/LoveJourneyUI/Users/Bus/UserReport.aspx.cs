...
public partial class Users_Bus_UserReport : System.Web.UI.Page
{
    ...
    void BindBookedTickets()
    {
        try
        {
            if (Session["UserID"] != null)
            {
                ...
                DataSet ds = obj.GetAgentBookedTicketsForAdminUser(null);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["UserID"] != null)
            {
                ...
                DataSet ObjDataset = (DataSet)objManabusBAL.SearchAgentBookedTicketsForAdminUser(AgentId);
                if (ObjDataset != null)
                {
                    if (ObjDataset.Tables.Count > 0)
                    {
