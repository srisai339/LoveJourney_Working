...
public partial class Users_Bus_CarPolicy : System.Web.UI.Page
{
    Class1 objBal;
    DataSet objDataSet;
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objBal.ScreenInd = Master123.InsertCarPolicy;
            objBal.id = id;

            if (objBal.fnInsertRecord() == true)
            {
                lblmsg.Text = "You have Sucessfully Saved  Your Car Policy";
                txtHotelPolicy.Text = "";
                BindAdminRemainder();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objBal = new Class1();
            objBal.ScreenInd = Master123.UpdateCarPolicy;
