<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="CarBooking.aspx.cs"   EnableEventValidation="false"  Inherits="CarBooking" %>
                        ...
                        <tr>
                            ...
                            <td width="35%" align="left">
                                <asp:TextBox ID="txtName" runat="server" CssClass="Textbox" />
                                 <ajax:autocompleteextender id="txtFrom_AutoCompleteExtender1" runat="server" targetcontrolid="txtname"
                        ...
                        <tr>
                            ...
                            <td width="18%" align="left">
                                ...
                                <asp:Button ID="btnReset" Text="Reset" runat="server" CssClass="buttonBook"
                                    Style="cursor: pointer;" onclick="btnReset_Click" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <td width="32%" align="left">
                        ...
                        <tr>
                            <td width="100%">
                                <asp:GridView ID="gvBookings" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                                    ...
                                    PageSize="100"  ShowFooter="true" onrowdatabound="gvBookings_RowDataBound" 
                                    onrowcommand="gvBookings_RowCommand" onrowediting="gvBookings_RowEditing">
                                    <Columns>
