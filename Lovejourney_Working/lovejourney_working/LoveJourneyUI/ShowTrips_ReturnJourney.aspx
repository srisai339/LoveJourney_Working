<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowTrips_ReturnJourney.aspx.cs"
    Inherits="ShowTrips_ReturnJourney" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Scripts/ShowTripsReturn.js" type="text/javascript"></script>
    ...
    <table width="100%" border="0">
        <tr>
            <td align="center" bgcolor="#013e7f">
                <table width="990" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="409" height="75" align="left">
                            <a href="Default.aspx">
                        ...
                        <td width="581" valign="bottom">
                            <table width="581" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="right" class="ma_hd">
                                        <table width="330" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="27" align="left">
                                                    <img src="images/contact1.png" width="19" height="17" />
                                                </td>
                                                <td align="left">
                                                    <a href="#"><strong>(080) 32 56 17 27</strong></a>
                                                </td>
                                                <td width="27" align="left">
                                                    <img src="images/mail.png" width="19" height="17" />
                                                </td>
                                                <td align="left">
                                                    <a href="#"><strong>info@lovejourney.in</strong></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td align="right">
                                        <table width="550" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td>
                                                    <table width="178" border="0" cellspacing="0" cellpadding="0" height="30">
                                                        <tr>
                                                            <td width="8">
                                                                <img src="images/b1.png" width="8" height="30" />
                                                            </td>
                                                            <td width="162" class="md_agen_bg" align="center">
                                                                <a href="BecomeAnAgent.aspx" style="color: White; text-decoration: none;">Agent Registration</a>
                                                            </td>
                                                            <td width="8">
                                                                <img src="images/b2.png" width="8" height="30" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td>
                                                    <table width="178" border="0" cellspacing="0" cellpadding="0" height="30">
                                                        <tr>
                                                            <td width="8">
                                                                <img src="images/lb1.png" width="8" height="30" />
                                                            </td>
                                                            <td width="162" class="md_agen_bg1" align="center">
                                                                <a href="UserRegistration.aspx" style="color: White; text-decoration: none;">User Registration</a>
                                                            </td>
                                                            <td width="8">
                                                                <img src="images/lb2.png" width="8" height="30" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                        ...
                        <td class="md_menu" height="30">
                            <div id="chromemenu" class="chromestyle">
                                <ul>
                                    ...
                                    <li><a href="Default.aspx">Buses</a></li>
                                    <li><a href="#" rel="dropmenu1">Flights</a></li>
                                    <li><a href="HotelSearch.aspx">Hotels</a></li>
                                    <li><a href="RDefault.aspx">Recharge</a></li>
                                        ...
                                        <tr>
                                            <td align="center" width="70%" style="border-bottom-width: 0px;">
                                                <asp:Label ID="lblOnwardJourneyHeader" runat="server" Text="<span style='color:#003B77;'> Return Journey :: </span>"
                                                    Visible="true" Font-Bold="True" Font-Size="14px" ForeColor="Red" Font-Names="Verdana"></asp:Label>
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td width="30%" valign="top" align="left">
                                                                <table width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="5px">
                                                                            <asp:DropDownList ID="ddlSources" onchange="LoadDestinations(); return false;" ValidationGroup="Modify"
                                                            ...
                                                            <td width="40%" valign="top" align="left">
                                                                ...
                                                                <asp:TextBox ID="lblJD" runat="server" ReadOnly="true" onclick="showDate();" onKeyPress="javascript: return false;"
                                                                    onPaste="javascript: return false;" Width="120px" CssClass="datepicker"></asp:TextBox>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                ...
                                                                <tr width="100%">
                                                                    ...
                                                                    <td width="60%" valign="top">
                                                                        ...
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="amount" readonly="readonly"
                                                                            style="border: 0; font-weight: bold; width: 175px; margin-left: 15px;" onkeypress="javascript: return false;"
                                                                            onpaste="javascript: return false;" oncontextmenu="javascript: return false;"
                                                                            onclick="javascript: return false;" />
                                                                        <input id="hdnMinFare" type="hidden" value="1" />
                                                                        <input id="hdnMaxFare" type="hidden" value="2500" />
                                                                    </td>
                                                                    <td width="32%" valign="top">
                                                                        <input id="Submit1" onclick="ResetFilters(); return false;" type="submit" value="Reset Filters"
                                                                            class="buttonBook" style="cursor: pointer;" />
                                                                    </td>
                                                                </tr>
                                                            </table>
        ...
        <tr>
            <td class="footer_bg" align="center">
                <table width="1010" border="0" bgcolor="#4f91cd" cellspacing="0" cellpadding="0">
                    <tr>
                        <td height="85">
                            <table width="824" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <%-- <tr>
                                    <td align="center"> 
                                        <a href="http://www.i2space.com/" target="_blank">
                                            <img src="images/power.png" width="209" height="11" /></a>
                                    </td>
                                </tr>--%>
                            </table>
                        </td>
