<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SuccessRecharge.aspx.cs" Inherits="SuccessRecharge" %>
                    ...
                    <tr>
                        <td valign="top" align="center">
                            <table width="900" class="master_content" border="0" cellspacing="0" cellpadding="0"
                                bgcolor="#ffffff">
                                <tr>
                                    <td class="heading" valign="middle" colspan="3" align="center" height="20px">
                                        Recharge Status
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3" height="20" align="center">
                                        <asp:Label ID="lblmsg" runat="server" Font-Bold="true" Font-Size="13px"></asp:Label>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    <td colspan="3" height="20" align="center">
                                        <asp:Label ID="lblreqid" runat="server" Font-Bold="true" Font-Size="13px"></asp:Label>
                                    </td>
                                </tr>
                                  <tr>
                                    <td>
                                 ...
                                 <tr height="20">
                                    <td class="admintext" valign="middle" align="center">
                                        <asp:Label ID="lblerror" runat="server" Text="" Font-Bold="true" Font-Size="13px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
